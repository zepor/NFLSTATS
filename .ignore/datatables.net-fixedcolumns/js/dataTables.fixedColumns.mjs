  ...
  var FixedColumns = /** @class */ (function () {
    ...
    FixedColumns.prototype._addStyles = function () {
      ...
      if (header !== null) {
        ...
        parentDiv = $$1(header.closest("div.dataTables_scroll")).css(
          "position",
          "relative",
        );
      }
      ...
      if (footer !== null) {
        ...
        if (parentDiv === null) {
          parentDiv = $$1(footer.closest("div.dataTables_scroll")).css(
            "position",
            "relative",
          );
        }
    ...
    FixedColumns.prototype._setKeyTableListener = function () {
      ...
      this.s.dt.on("key-focus.dt.dtfc", function (e, dt, cell) {
        ...
        var scroll = $$1(
          $$1(_this.s.dt.table().node()).closest("div.dataTables_scrollBody"),
        );
