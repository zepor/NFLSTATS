      ...
      function s(t, e) {
        ...
        function y(t) {
          var o = (function () {
            ...
            x = b.selectAll("line").data(o, e).order(),
            v = x.exit(),
            C = x.enter().append("line").attr("class", "grid-line");
          if (((x = x.merge(C)), t !== y)) {
            var O = function (t) {
                return function (e) {
    ...
    function (t, e, n) {
      ...
      function t() {
        var t,
          ...
          z = 5,
          W = 1,
          V = O.default.colorSchemas.britecharts,
          K = null,
          Z = g.easeQuadInOut,
          Q = !1,
          X = !1,
        ...
        function pt(f) {
          G && (U = Object(A.a)(G)),
            f.each(function (f) {
                ...
                j = Object(d.nest)()
                  ...
                  .map(function (t) {
                    return Object.assign(
                      {},
                      {
                        total: Object(l.sum)(Object(l.permute)(t.value, D)),
                        key: t.key,
                      },
                      t.value,
                    );
                ...
                c ||
                  ...
                  (function () {
                    var t = c
                      ...
                      .attr(
                        "transform",
                        "translate(".concat(_.left, ",").concat(_.top, ")"),
                      );
              ...
              H)
                ? c.select(".loading-state-group").html(w.barLoadingMarkup)
                : (c.select(".loading-state-group svg").remove(),
                    ...
                    Q
                      ...
                      : ((t = Object(m.scaleBand)()
                        ...
                        (n = Object(m.scaleLinear)()
                          ...
                          .rangeRound([L, 0])
                          .nice()));
                    (o = Object(m.scaleOrdinal)().range(V).domain(T.map(lt))),
                      (K =
                        K ||
                        o
                          .domain(T.map(lt))
                  ...
                  (function () {
                    c.select(".grid-lines-group").selectAll("grid").remove(),
                      ("horizontal" === rt || "full" === rt) && gt();
                    ("vertical" !== rt && "full" !== rt) || yt();
                    Q ? yt() : gt();
                  })(),
                  (function (o) {
                    Q
                      ? ((e = Object(s.axisBottom)(t).ticks(z, o.format(ct))),
                        (r = Object(s.axisLeft)(n)))
                      : ((e = Object(s.axisBottom)(t)),
                        (r = Object(s.axisLeft)(n).ticks(Y, o.format(ct))));
                  })(U),
                  (function () {
                    Q
                      ? (c
                          .select(".x-axis-group .axis.x")
                          .attr("transform", "translate( 0, ".concat(L, " )"))
                          .call(e),
                        c
                          .select(".y-axis-group.axis")
                          .attr("transform", "translate( ".concat(-tt, ", 0)"))
                          .call(r))
                      : (c
                          .select(".x-axis-group .axis.x")
                          .attr("transform", "translate( 0, ".concat(L, " )"))
                        ...
                        c
                          ...
                          .call(ht));
                    B &&
                      (P && c.selectAll(".y-axis-label-text").remove(),
                      (P = c
                        .select(".y-axis-label")
                        .append("text")
                  ...
                  (function () {
                    F && c.selectAll(".layer").remove();
                    var e = c.select(".chart-group").selectAll(".layer");
                    (R = Object(l.range)(20, 20 * (a[0].length + 1), 20)),
                      Q
                        ? ((r = e.data(a)),
                          (o = (F = r
                            .enter()
                        ...
                        .on("mousemove", function (e) {
                          ...
                          (u = bt((r = this))),
                            ...
                            (d = Q ? vt(f) : xt(s)) &&
                              (Q
                                ? ((o = s - _.left),
                                  (a = n(d.key) + n.bandwidth() / 2))
                                : ((o = t(d.key) + _.left), (a = f - _.bottom)),
                              (p = o),
                              (h = a),
                              c
                                .select(".metadata-group")
                              ...
                              dt.call("customMouseMove", r, d, K, o, a));
                        })
                        .on("click", function (t) {
                          var e, n, r, o, a, c;
                          (n = bt((e = this))),
                            ...
                            (a = r[1]),
                            (c = Q ? vt(a) : xt(o)),
                            dt.call("customClick", e, c, Object(x.mouse)(e));
                        });
                    c.selectAll(".bar").on("mouseover", Ct).on("mouseout", Ot);
                  })());
            });
        }
        function ht(t) {
        ...
        function gt() {
          Object(S.a)(n).range([0, k]).hideEdges("first").ticks(Y)(
        ...
        function yt() {
          Object(S.b)(t).range([0, L]).hideEdges("first").ticks(z)(
            c.select(".grid-lines-group"),
          ),
            c
              .select(".grid-lines-group")
        ...
        function mt(t) {
          return t.map(function (t) {
            for (var e = 0; e < t.length; e++) t[e] = st(t[e]);
            return t;
          });
        }
        function bt(t) {
        ...
        function At(t) {
          var e = n(t[0]) - n(t[1]),
            ...
            o = Object(y.interpolateRound)(0, st(e)),
        ...
        return (
          ...
          (pt.exportChart = function (t, e) {
            return v.a.call(pt, c, t, e);
          }),
          (pt.grid = function (t) {
            return arguments.length ? ((rt = t), this) : rt;
          }),
          (pt.hasPercentage = function (t) {
            return arguments.length
              ? ((ct = t ? "%" : ",f"), this)
              : "%" === ct;
          }),
          ...
          (pt.hasReversedStacks = function (t) {
          ...
          (pt.isLoading = function (t) {
            return arguments.length ? ((H = t), this) : H;
          }),
          (pt.margin = function (t) {
            return arguments.length ? ((_ = E(E({}, _), t)), this) : _;
          }),
          (pt.nameLabel = function (t) {
            return arguments.length
              ? ((ot = t), Object(C.a)("name"), this)
              : ot;
          }),
          ...
          (pt.percentageAxisToMaxRatio = function (t) {
            return arguments.length ? ((W = t), this) : W;
          }),
          (pt.stackLabel = function (t) {
            return arguments.length
              ? ((it = t), Object(C.a)("stack"), this)
              : it;
          }),
