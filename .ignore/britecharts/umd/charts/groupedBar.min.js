      ...
      function s(t, e) {
        ...
        function y(t) {
          var o = (function () {
            ...
            m = y.selectAll(p.asSelector()).data([null]),
            b = m.merge(m.enter().append("g").attr("class", p.asList())),
            v = b.selectAll("line").data(o, e).order(),
            x = v.exit(),
            C = v.enter().append("line").attr("class", "grid-line");
          if (((v = v.merge(C)), t !== y)) {
            var O = function (t) {
                return function (e) {
    ...
    function (t, e, n) {
      ...
      function t() {
        var t,
          ...
          P,
          _,
          I = { top: 40, right: 30, bottom: 60, left: 70 },
          N = 960,
          H = 500,
          q = !1,
          G = { y: -8, x: -20 },
          ...
          V && (K = Object(w.a)(V)),
            p.each(function (p) {
              (k = N - I.left - I.right),
                ...
                (function (t) {
                  L ||
                    ...
                    (function () {
                      ...
                      L.append("g").classed("loading-state-group", !0),
                        t
                          .append("g")
                ...
                q
                  ? L.select(".loading-state-group").html(O.barLoadingMarkup)
                  : ((function (t) {
                      (e = t.map(ft)),
                    ...
                    (function () {
                      var n =
                        ...
                        1 === a.size && a.has(0)
                          ? 1
                          : Object(l.max)(j.map(st)));
                      var a;
                      Q
                        ? ((t = Object(m.scaleLinear)()
                            .domain([0, n])
                            .rangeRound([0, k - 1])),
                          (r = Object(m.scaleBand)()
                            .domain(j.map(lt))
                            .rangeRound([T, 0])
                            .padding(ut)),
                          (o = Object(m.scaleBand)()
                            .domain(j.map(ft))
                        ...
                        : ((t = Object(m.scaleBand)()
                            ...
                            .rangeRound([0, k])
                            .padding(ut)),
                          (e = Object(m.scaleBand)()
                            .domain(j.map(ft))
                            .rangeRound([0, t.bandwidth()])
                            .padding(ut)),
                          (r = Object(m.scaleLinear)()
                            .domain([0, n])
                            .rangeRound([T, 0])
                            .nice()));
                      (c = Object(m.scaleOrdinal)().range(z).domain(j.map(ft))),
                        (W =
                          W ||
                          c
                            .domain(j.map(lt))
                    ...
                    L.select(".loading-state-group svg").remove(),
                    (function () {
                      L.select(".grid-lines-group").selectAll("grid").remove(),
                        ("horizontal" === nt || "full" === nt) && yt();
                      ("vertical" !== nt && "full" !== nt) || mt();
                      Q ? mt() : yt();
                    })(),
                    (function (e) {
                      Q
                        ? ((n = Object(s.axisBottom)(t).ticks(Y, e.format(it))),
                          (a = Object(s.axisLeft)(r)))
                        : ((n = Object(s.axisBottom)(t)),
                          (a = Object(s.axisLeft)(r).ticks(U, e.format(it))));
                    })(K),
                    (function () {
                      Q
                        ? (L.select(".x-axis-group .axis.x")
                            .attr("transform", "translate( 0, ".concat(T, " )"))
                            .call(n),
                          L.select(".y-axis-group.axis")
                            .attr("transform", "translate( ".concat(-J, ", 0)"))
                            .call(a))
                        : (L.select(".x-axis-group .axis.x")
                            .attr("transform", "translate( 0, ".concat(T, " )"))
                            .call(n),
                          L.select(".y-axis-group.axis")
                            ...
                            .call(gt));
                      R &&
                        (P && L.selectAll(".y-axis-label-text").remove(),
                        (P = L.select(".y-axis-label")
                          .append("text")
                    ...
                    (function () {
                      D && L.selectAll(".layer").remove();
                      var n = L.select(".chart-group").selectAll(".layer");
                      (_ = Object(l.range)(20, 20 * (B.length + 1), 20)),
                        Q
                          ? ((a = n.data(S)),
                            (i = (D = a
                              .enter()
                          ...
                          .on("mousemove", function (n) {
                            ...
                            (u = bt((o = this))),
                              ...
                              (d = Q ? xt(f) : vt(s)) &&
                                ...
                                pt.call("customMouseMove", o, d, W, a, c));
                          })
                          .on("click", function (t) {
                            var e, n, r, o, a, c;
                            (n = bt((e = this))),
                              ...
                              (a = r[1]),
                              (c = Q ? xt(a) : vt(o)),
                              pt.call("customClick", e, c, Object(b.mouse)(e));
                          });
                      L.selectAll(".bar")
                        .on("mouseover", function (t) {
                          !(function (t, e) {
                            Object(b.select)(t).attr("fill", function () {
                              return Object(f.color)(W[e.group]).darker();
                            });
                          })(this, t);
                        })
                        .on("mouseout", function (t) {
        ...
        function yt() {
          Object(M.a)(r).range([0, k]).hideEdges("first").ticks(U)(
        ...
        function mt() {
          Object(M.b)(t).range([0, T]).hideEdges("first").ticks(Y)(
            L.select(".grid-lines-group"),
          ),
            L.select(".grid-lines-group")
          ...
          return (
            S.forEach(function (n) {
              var i = n.values.find(function (n) {
                return (
                  Math.abs(r >= t(n[rt]) + e(n[at])) &&
                  Math.abs(r - e(n[at]) - t(n[rt]) <= o)
                );
              });
              i && ((i.values = n.values), (i.key = i.name), a.push(i));
            }),
            a.length ? a[0] : void 0
          );
        }
          ...
          return (
            S.map(function (t) {
              var a = t.values.find(function (t) {
                return (
                  Math.abs(e >= r(t[rt])) && Math.abs(e - r(t[rt]) <= 2 * n)
                );
              });
              a && ((a.values = t.values), (a.key = a.name), o.push(a));
            }),
            o.length ? o[0] : void 0
          );
        }
        function Ct(e) {
          var n = Object(b.select)(this),
            r = Object(y.interpolateRound)(0, t(st(e))),
        ...
        function Ot(t) {
          var e = Object(b.select)(this),
            n = Object(y.interpolateRound)(0, T - r(st(t))),
            o = Object(y.interpolateRound)(T, r(st(t))),
            a = Object(y.interpolateNumber)(0, 1);
          return function (t) {
            e.attr("y", o(t)).attr("height", n(t)).style("opacity", a(t));
          };
        }
        return (
          (ht.animationDuration = function (t) {
            return arguments.length ? ((et = t), this) : et;
          }),
          (ht.betweenBarsPadding = function (t) {
            return arguments.length ? ((ct = t), this) : ct;
          }),
          (ht.betweenGroupsPadding = function (t) {
            return arguments.length ? ((ut = t), this) : ut;
          }),
          (ht.colorMap = function (t) {
            return arguments.length ? ((W = t), this) : W;
          }),
          (ht.colorSchema = function (t) {
            return arguments.length ? ((z = t), this) : z;
          }),
          (ht.exportChart = function (t, e) {
            return v.a.call(ht, L, t, e);
          }),
          (ht.groupLabel = function (t) {
            return arguments.length
              ? ((at = t), Object(x.a)("group"), this)
              : at;
          }),
          (ht.grid = function (t) {
          ...
          (ht.isHorizontal = function (t) {
            return arguments.length ? ((Q = t), this) : Q;
          }),
          (ht.isAnimated = function (t) {
            return arguments.length ? ((dt = t), this) : dt;
          }),
          (ht.isLoading = function (t) {
            return arguments.length ? ((q = t), this) : q;
          }),
          (ht.margin = function (t) {
            return arguments.length ? ((I = E(E({}, I), t)), this) : I;
          }),
          (ht.nameLabel = function (t) {
            return arguments.length
              ? ((rt = t), Object(x.a)("name"), this)
              : rt;
          }),
          ...
          (ht.valueLabel = function (t) {
            return arguments.length
              ? ((ot = t), Object(x.a)("value"), this)
              : ot;
          }),
          (ht.valueLocale = function (t) {
