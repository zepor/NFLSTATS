    ...
    function (t, e, n) {
      ...
      function g(t, e) {
        if (t) {
          ...
          var n = u.a.initializeSerializer()(t.node());
          return (
            (n = (function (t) {
    ...
    function (t, e, n) {
      ...
      var r = n(3),
        ...
        u = function (t) {
          ...
          return { x1: s, y1: u * e + l, x2: f, y2: u * f + l };
        },
        s = function (t, e, n) {
          var o = e ? (t / e) * 100 : 0;
    ...
    function (t, e, n) {
      ...
      function t() {
        var t,
          ...
          S,
          E,
          T = { left: 5, right: 5, top: 5, bottom: 5 },
          L = 100,
          k = 30,
          F = !1,
          D = ["#F5FDFF", "#F6FEFC"],
          B = Object(m.f)("sparkline-area-gradient"),
          P = h.default.colorGradients.greenBlue,
          j = Object(m.f)("sparkline-line-gradient"),
          R = Object(m.f)("maskingClip"),
          I = !1,
          H = y.e.duration,
          N = l.easeQuadInOut,
          G = v,
            ...
            (b = L - T.left - T.right),
                ...
                a ||
                  ...
                  (function () {
                    var t = a
                      ...
                      .attr(
                        "transform",
                        "translate(".concat(T.left, ",").concat(T.top, ")"),
                      );
                    a.append("g").classed("loading-state-group", !0),
                      t.append("g").classed("text-group", !0),
                      t.append("g").classed("chart-group", !0),
                      t.append("g").classed("metadata-group", !0);
                  })());
                a.attr("viewBox", [0, 0, L, k])
                  .attr(
                    "style",
              ...
              F
                ? a
                    ...
                    .html(g.sparkLineLoadingMarkup)
                : (a.select(".loading-state-group svg").remove(),
                  (t = Object(u.scaleLinear)()
                    .domain(Object(c.extent)(w, q))
                    .range([0, b])),
                  (e = Object(u.scaleLinear)()
                    .domain(Object(c.extent)(w, Y))
                    .range([x, 0])),
                  (function () {
                    var e = a.select(".metadata-group");
                    (n || r) &&
                      (a.selectAll("#".concat(B)).remove(),
                      a.selectAll("#".concat(j)).remove());
                    (n = e
                      ...
                      .attr("x1", 0)
                      .attr("x2", t(w[w.length - 1].date))
                      .attr("y1", 0)
                      .attr("y2", 0)
                      .selectAll("stop")
                      .data([
                        { offset: "0%", color: D[0] },
                        { offset: "100%", color: D[1] },
                      ])
                      .enter()
                      .append("stop")
                  ...
                  (function () {
                    A && a.selectAll(".sparkline-area").remove();
                    (A = Object(s.area)()
                      .x(function (e) {
                        var n = e.date;
                        return t(n);
                      ...
                      a
                        ...
                        .attr("d", A)
                        .attr("clip-path", "url(#".concat(R, ")"));
                  })(),
                  (function () {
                    O && a.selectAll(".line").remove();
                    (O = Object(s.line)()
                      .curve(s.curveBasis)
                      .x(function (e) {
                        var n = e.date;
                      ...
                      a
                        ...
                        .datum(w)
                        .attr("class", "line")
                        .attr("stroke", "url(#".concat(j, ")"))
                        .attr("d", O)
                        .attr("clip-path", "url(#".concat(R, ")"))
                        .attr("fill", "none");
                  })(),
                  (function () {
                    M && a.selectAll(".sparkline-circle").remove();
                    M = a
                      .selectAll(".chart-group")
                      .append("circle")
                      .attr("class", "sparkline-circle")
                      .attr("cx", t(w[w.length - 1].date))
                      .attr("cy", e(w[w.length - 1].value))
                      .attr("r", 1.5);
                  })(),
                  E &&
                    (function () {
                      S && a.selectAll(".sparkline-text").remove();
                      S = a
                        ...
                        .style("font-size", G["font-size"] || v["font-size"])
                        .style("fill", G.fill || P[0])
                        .style(
                          "font-family",
                          G["font-family"] || v["font-family"],
                        )
                        .style(
                          "font-weight",
                          G["font-weight"] || v["font-weight"],
                        )
                        .style("font-style", G["font-style"] || v["font-style"])
                        .text(E);
                    })());
          });
        }
        return (
          (z.animationDuration = function (t) {
          ...
          (z.dateLabel = function (t) {
            return arguments.length ? ((U = t), Object(p.a)("date"), this) : U;
          }),
          (z.exportChart = function (t, e) {
            return d.a.call(z, a, t, e);
          }),
          (z.height = function (t) {
          ...
          (z.isLoading = function (t) {
            return arguments.length ? ((F = t), this) : F;
          }),
          (z.margin = function (t) {
            return arguments.length ? ((T = C(C({}, T), t)), this) : T;
          }),
          ...
          (z.valueLabel = function (t) {
            return arguments.length ? ((_ = t), Object(p.a)("value"), this) : _;
          }),
          (z.width = function (t) {
