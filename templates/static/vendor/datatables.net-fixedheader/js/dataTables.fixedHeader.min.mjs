...
let $ = jQuery;
var _instCounter = 0,
  FixedHeader = function (t, e) {
    if (!(this instanceof FixedHeader))
      throw "FixedHeader must be initialised with the 'new' keyword.";
    !0 === e && (e = {}),
      (t = new DataTable.Api(t)),
      (this.c = $.extend(!0, {}, FixedHeader.defaults, e)),
      (this.s = {
        dt: t,
        position: {
          theadTop: 0,
      ...
      (this.dom = {
        floatingHeader: null,
        thead: $(t.table().header()),
        tbody: $(t.table().body()),
        tfoot: $(t.table().footer()),
        header: {
          host: null,
          floating: null,
...
$.extend(FixedHeader.prototype, {
        ...
        ($(window)
          ...
          .on(
            ...
            DataTable.util.throttle(function () {
              (o.s.position.windowHeight = $(window).height()), o.update();
            }, 50),
          ),
        $(".fh-fixedHeader")),
      t =
  ...
  _clone: function (t, e) {
    ...
    ("footer" === t && this._scrollEnabled()) ||
      (!e && d.floating
        ...
        : (d.floating &&
            (null !== d.placeholder && d.placeholder.remove(),
            this._unsize(t),
          ...
          (d.floating = $(a.table().node().cloneNode(!1))
          ...
          d.floatingParent
            ...
            .append(d.floating)
            .appendTo("body"),
          this._stickyPosition(d.floating, "-"),
          (a = function () {
            var t = o.scrollLeft();
            (s.s.scrollLeft = { footer: t, header: t }),
              d.floatingParent.scrollLeft(s.s.scrollLeft.header);
          })(),
          o.off("scroll.dtfh").on("scroll.dtfh", a),
          (d.placeholder = r.clone(!1)),
  ...
  _stickyPosition: function (t, i) {
    ...
    this._scrollEnabled() &&
      ((s = this),
      (a = "rtl" === $(s.s.dt.table().node()).css("direction")),
      t.find("th").each(function () {
        var t, e, o;
        "sticky" === $(this).css("position") &&
          ((t = $(this).css("right")),
          (e = $(this).css("left")),
          "auto" === t || a
            ? "auto" !== e &&
              ...
              $(this).css("left", 0 < o ? o : 0))
            : ((o =
                +t.replace(/px/g, "") +
                ("-" === i ? -1 : 1) * s.s.dt.settings()[0].oBrowser.barWidth),
              $(this).css("right", 0 < o ? o : 0)));
      }));
  },
  _matchWidths: function (e, o) {
    ...
    function i(t, e) {
      $(t, o).each(function (t) {
        $(this).css({ width: e[t], minWidth: e[t] });
      });
    }
    var s = t("th"),
      a = t("td");
  ...
  _unsize: function (t) {
    ...
    e && ("footer" === t || ("header" === t && !this.s.autoWidth))
      ? $("th, td", e).css({ width: "", minWidth: "" })
      : e && "header" === t && $("th, td", e).css("min-width", "");
  },
  _horizontal: function (t, e) {
    ...
    i.floating &&
      s[t] !== e &&
      (this._scrollEnabled() &&
        ((o = $($(this.s.dt.table().node()).parent()).scrollLeft()),
  ...
  _modeChange: function (t, e, o) {
    ...
    ("footer" === e && c) ||
      ...
      (s = $.contains(d[0], document.activeElement)
        ? document.activeElement
        : null),
      (r = $($(this.s.dt.table().node()).parent())),
      "in-place" === t
        ? (f.placeholder && (f.placeholder.remove(), (f.placeholder = null)),
          this._unsize(e),
          "header" === e ? f.host.prepend(d) : f.host.append(d),
          f.floating &&
            (f.floating.remove(),
            (f.floating = null),
            this._stickyPosition(f.host, "+")),
          f.floatingParent && f.floatingParent.remove(),
          $($(f.host.parent()).parent()).scrollLeft(r.scrollLeft()))
        : "in" === t
        ? (this._clone(e, o),
          (d = r.offset()),
          (h = (a = $(document).scrollTop()) + $(window).height()),
          (n = c ? d.top : l.tbodyTop),
          (d = c ? d.top + r.outerHeight() : l.tfootTop),
          (r =
            "footer" === e
              ? h < n
                ? l.tfootHeight
                : n + l.tfootHeight - h
              : a + this.c.headerOffset + l.theadHeight - d),
          (n = "header" === e ? "top" : "bottom"),
          (h = this.c[e + "Offset"] - (0 < r ? r : 0)),
  ...
  _positions: function () {
    ...
    (o.visible = e.is(":visible")),
      ...
      (o.theadTop = a.offset().top),
      (o.tbodyTop = (s ? d : i).offset().top),
      (o.tbodyHeight = (s ? d : i).outerHeight()),
      (o.theadHeight = a.outerHeight()),
  ...
  _scroll: function (t) {
    var e, o, i, s, a, d, r, n, h, f, l, c, p, g, u, b;
    this.s.dt.settings()[0].bDestroying ||
      ((e = this._scrollEnabled()),
      (o = (f = $(this.s.dt.table().node()).parent()).offset()),
      (c = f.outerHeight()),
      (i = $(document).scrollLeft()),
      ...
      this.c.footer &&
        ...
        (!this.s.enable ||
        !p.visible ||
        p.tfootBottom + this.c.footerOffset <= n
          ? (a = "in-place")
          : c + p.tfootHeight + this.c.footerOffset > n &&
            b + this.c.footerOffset < n
          ? ((a = "in"), (t = !0))
          : (a = "above"),
        (!t && a === this.s.footerMode) || this._modeChange(a, "footer", t),
        this._horizontal("footer", i),
        (l = function (t) {
          return { offset: t.offset(), height: t.outerHeight() };
        }),
        (g = this.dom.header.floating
          ? l(this.dom.header.floating)
          : l(this.dom.thead)),
        (u = this.dom.footer.floating
        ...
        e &&
          ...
          ((p =
            n +
            ((c = s - o.top) > -g.height ? c : 0) -
            (g.offset.top + (c < -g.height ? g.height : 0) + u.height)),
          f.outerHeight((p = p < 0 ? 0 : p)),
          Math.round(f.outerHeight()) >= Math.round(p)
            ? $(this.dom.tfoot.parent()).addClass("fixedHeader-floating")
            : $(this.dom.tfoot.parent()).removeClass("fixedHeader-floating"))),
      this.dom.header.floating &&
        this.dom.header.floatingParent.css("left", d - i),
      this.dom.footer.floating &&
        this.dom.footer.floatingParent.css("left", d - i),
        ...
        ((this.dom.header.rightBlocker = (b = function (t, e, o) {
          ...
          return (
            null !==
              (o =
                void 0 === o
                  ? 0 === (i = $("div.dtfc-" + t + "-" + e + "-blocker")).length
                    ? null
              ...
              ("in" === h || "below" === h
                ? o
                    .appendTo("body")
                    .css({
                      top: ("top" === e ? g : u).offset.top,
                      left: "right" === t ? d + r - o.width() : d,
                    })
                : o.detach()),
            o
          );
  ...
  ($.fn.DataTable.FixedHeader = FixedHeader),
  $(document).on("init.dt.dtfh", function (t, e, o) {
    var i;
    "dt" === t.namespace &&
      ((t = e.oInit.fixedHeader),
      (i = DataTable.defaults.fixedHeader),
      (!t && !i) ||
        e._fixedHeader ||
        ((i = $.extend({}, i, t)), !1 !== t && new FixedHeader(e, i)));
  }),
  ...
  DataTable.Api.register("fixedHeader.enable()", function (e) {
    return this.iterator("table", function (t) {
      t = t._fixedHeader;
  ...
  $.each(["header", "footer"], function (t, o) {
    DataTable.Api.register("fixedHeader." + o + "Offset()", function (e) {
      var t = this.context;
      return void 0 === e
