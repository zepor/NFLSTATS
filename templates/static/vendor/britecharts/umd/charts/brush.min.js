  ...
  return (function (t) {
      ...
      var n = r(3),
        ...
        l = function (t) {
          ...
          t.forEach(function (t) {
            (r += t.x), (n += t.y), (a += t.x * t.y), (i += t.x * t.x);
          });
          var u = e * i - r * r,
            c = (n * i - r * a) / u,
            l = (e * a - r * n) / u,
    ...
    function (t, e, r) {
      ...
      r.r(e),
        ...
        r.d(e, "barLoadingMarkup", function () {
          return o;
        }),
        r.d(e, "donutLoadingMarkup", function () {
          return a;
        }),
        r.d(e, "lineLoadingMarkup", function () {
          return i;
        }),
        r.d(e, "stackedAreaLoadingMarkup", function () {
          return u;
        }),
        r.d(e, "sparkLineLoadingMarkup", function () {
          return c;
        }),
        r.d(e, "brushLoadingMarkup", function () {
          return l;
        });
      var n =
        ...
        b = function (t, e) {
          ...
          n &&
            ("undefined" == typeof Intl ||
              ("object" ===
                ("undefined" == typeof Intl ? "undefined" : u()(Intl)) &&
                !Intl.DateTimeFormat)) &&
            (n = null),
            r || (r = g(c));
          var l = r.split("-"),
    ...
    function (t, e, r) {
      ...
      function t() {
        var t,
          ...
          Y = null,
          G = "monotoneX",
          N = h.default.colorGradients.greenBlue,
          R = Object(b.f)("brush-area-gradient"),
          I = "timeDay",
          U = Object(d.dispatch)("customBrushStart", "customBrushEnd"),
          W = function (t) {
            return t.value;
          },
          z = function (t) {
        ...
        function X(d) {
          d.each(function (d) {
            ...
            (function (t) {
              r ||
                ...
                (function () {
                  ...
                  r.append("g").classed("loading-state-group", !0),
            ...
            L)
              ? r.select(".loading-state-group").html(x.brushLoadingMarkup)
              : ((a = Object(s.scaleTime)()
                  .domain(Object(u.extent)(t, z))
                  .range([0, n])),
                (v = Object(s.scaleLinear)()
                  .domain([0, Object(u.max)(t, W)])
                  .range([o, 0])),
                (function () {
                  var e, i;
                  if ("custom" === q && "string" == typeof Y)
                    (e = {
                      tick: P,
                      format: Object(m.timeFormat)(Y),
                    }),
                      (i = null);
                  else {
                    var u = g.a.getTimeSeriesAxis(t, _, q);
                    (e = u.minor),
                      (i = u.major),
                      (O = Object(c.axisBottom)(a)
                        .ticks(i.tick)
                        .tickSize(0, 0)
                        .tickFormat(i.format));
                  }
                  (M = Object(c.axisBottom)(a)
                    .ticks(e.tick)
                    .tickSize(10, 0)
                    .tickPadding([5])
                    .tickFormat(e.format)),
                ...
                r.select(".loading-state-group svg").remove(),
                D ||
                  (D = r
                    ...
                    .attr("x1", 0)
                    .attr("x2", a(t[t.length - 1].date))
                    .attr("y1", 0)
                    .attr("y2", 0)
                    .selectAll("stop")
                    .data([
                      { offset: "0%", color: N[0] },
                      { offset: "100%", color: N[1] },
                    ])
                    .enter()
                    .append("stop")
                ...
                (function () {
                  A &&
                    ...
                    r.selectAll(".missing-brush-area").remove());
                  (A = Object(f.area)()
                    .defined(function (t) {
                      var e = t.value;
                    ...
                    .curve(y.b[G])),
                    T
                      ? (e.filter(A.defined()).length !== e.length &&
                          (r
                            .select(".chart-group")
                            .append("path")
                            .datum(e.filter(A.defined()))
                            .attr("class", "missing-brush-area")
                            .attr("d", A),
                          r
                            .select(".chart-group")
                            .selectAll(".missing-brush-area")
                            .datum(t.filter(A.defined()))
                            .transition()
                            .duration(B)
                            .attr("d", A)),
                        r
                        ...
                        r
                          ...
                          .duration(B)
                          .attr("d", A))
                      : (t.filter(A.defined()).length !== t.length &&
                          r
                            .select(".chart-group")
                            .append("path")
                            .datum(t.filter(A.defined()))
                ...
                "custom" !== q &&
                  r
                    ...
                    .call(O),
                (function () {
                  (j = r.select(".brush-group").call(k)),
                    T &&
                      (j.style("opacity", 0),
                      setTimeout(function () {
                        j.transition().duration(B).style("opacity", 1);
                      }, 0));
                  j
                    .selectAll("rect")
                    ...
                    j
                      .selectAll(".selection")
                      .attr("fill", "url(#".concat(R, ")"));
                })(),
                (w = h.default.colorSchemasHuman.grey[1]),
                j.selectAll(".handle.brush-rect").style("fill", w));
          });
        }
        function Z() {
          var t,
          ...
          if (e) {
            if (H) {
              var r = Math.floor(a(new Date(E[1])) - a(new Date(E[0]))),
                n = Math.floor(e[1] - e[0]);
              n < r || n > r
                ? ((t = [Math.floor(e[0]), Math.floor(e[0]) + r]), k.move(j, t))
                : (t = e);
            } else t = e;
            U.call("customBrushStart", this, t.map(a.invert));
          }
        }
        function J() {
          if (p.event.sourceEvent) {
            var t = [null, null],
              e = p.event.selection;
            if (e) {
              var r = e.map(a.invert);
              (t = r.map(y.g[I].round))[0] >= t[1] &&
                ((t[0] = y.g[I].floor(r[0])), (t[1] = y.g[I].offset(t[0]))),
                Object(p.select)(this)
                  .transition()
                  .call(p.event.target.move, t.map(a));
            } else H && $.apply(void 0, i()(E));
        ...
        return (
          ...
          (X.dateRange = function (t) {
            return arguments.length
              ? ((E = t), Array.isArray(E) && $.apply(void 0, i()(E)), this)
              : E;
          }),
          ...
          (X.margin = function (t) {
            return arguments.length ? ((S = C(C({}, S), t)), this) : S;
          }),
          (X.on = function () {
