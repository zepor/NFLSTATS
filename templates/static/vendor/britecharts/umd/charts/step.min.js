      ...
      function t() {
        ...
        function G(s) {
          s.each(function (s) {
            ...
            (function (t) {
              w ||
                ...
                (function () {
                  ...
                  w.append("g").classed("loading-state-group", !0),
            ...
            S)
              ? w.select(".loading-state-group").html(h.barLoadingMarkup)
              : (w.select(".loading-state-group svg").remove(),
                ...
                (C = Object(l.axisLeft)(o)
                  ...
                  .tickFormat(R)),
                (function () {
                  A && w.selectAll(".horizontal-grid-line").remove();
                ...
                (u = w.select(".chart-group").selectAll(".step").data(t))
                  .enter()
                  .append("rect")
                  .classed("step", !0)
                  .attr("x", e)
                  ...
                  .on("mouseover", function (t) {
                    !(function (t, e, n, r) {
                      D.call("customMouseOver", t, e, Object(p.mouse)(t), [
                        n,
                        r,
                      ]);
                    })(this, t, e, n);
                  ...
                  .on("mousemove", function (t) {
                    !(function (t, e, n, r) {
                      D.call("customMouseMove", t, e, Object(p.mouse)(t), [
                        n,
                        r,
                      ]);
                    })(this, t, e, n);
                  ...
                  .on("mouseout", function (t) {
                    !(function (t, e, n, r) {
                      D.call("customMouseOut", t, e, Object(p.mouse)(t), [
                        n,
                        r,
                      ]);
                    })(this, t, e, n);
                ...
                (function () {
                  w
                    ...
                    y &&
                      (b && w.selectAll(".x-axis-label-text").remove(),
                      (b = w
                        .select(".x-axis-label")
                        .append("text")
                        .attr("y", P)
                  ...
                  w.select(".y-axis-group.axis").call(C),
                    m &&
                      (v && w.selectAll(".y-axis-label-text").remove(),
                      (v = w
                        .select(".y-axis-label")
                        .append("text")
        ...
        return (
          ...
          (G.margin = function (t) {
            return arguments.length ? ((M = x(x({}, M), t)), this) : M;
          }),
          (G.yTicks = function (t) {
