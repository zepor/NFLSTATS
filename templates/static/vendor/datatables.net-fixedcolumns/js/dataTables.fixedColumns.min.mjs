...
!(function () {
  ...
  (l.prototype.left = function (t) {
    ...
    (l.prototype._addStyles = function () {
      this.s.dt.settings()[0].oScroll.sY &&
        ((s = D(this.s.dt.table().node()).closest(
      ...
      for (
        var t = null,
          ...
          i =
            (null !== s &&
              ((e = (s = D(s)).outerHeight() + 1),
              (t = D(s.closest("div.dataTables_scroll")).css(
                "position",
                "relative",
              ))),
          ...
          o =
            (null !== i &&
              ((l = (i = D(i)).outerHeight()),
              null === t &&
                (t = D(i.closest("div.dataTables_scroll")).css(
                  "position",
                  "relative",
                ))),
          ...
          r = 0,
          d = 0,
          h = D(this.s.dt.table().node()).children("tbody").children("tr"),
          a = 0,
          c = new Map(),
          n = 0;
        n < o;
        ...
        var f = this.s.dt.column(n);
        if ((0 < n && c.set(n - 1, a), f.visible())) {
          var u = D(f.header()),
            m = D(f.footer());
          if (n - a < this.c.left) {
            if (
              (D(this.s.dt.table().node()).addClass(
              ...
              for (var g = n; g + 1 < o; ) {
                if (
                  ...
                  (r += D(S.nodes()[0]).outerWidth()),
                    (d +=
                      S.header() || S.footer()
                        ? D(S.header()).outerWidth()
                        : 0);
                  break;
                }
                g--;
            ...
            for (var x = 0, b = h; x < b.length; x++) {
              v = b[x];
              (R = D(D(v).children()[n - a])).hasClass(
      ...
      for (var B = 0, k = 0, _ = 0, n = o - 1; 0 <= n; n--)
        if ((f = this.s.dt.column(n)).visible()) {
          var u = D(f.header()),
            m = D(f.footer()),
            y = c.get(n);
          if ((void 0 === y && (y = a), n + _ >= o - this.c.right)) {
            if (
              (D(this.s.dt.table().node()).addClass(
            ...
            for (var W = 0, w = h; W < w.length; W++) {
              var R,
                v = w[W];
              (R = D(D(v).children()[n - y])).hasClass(
    ...
    (l.prototype._getCellCSS = function (t, s, e) {
      return "left" === e
        ? this.s.rtl
    ...
    (l.prototype._clearCellCSS = function (t) {
      return "left" === t
        ? this.s.rtl
          ? { position: "", right: "" }
          : { left: "", position: "" }
    ...
    (l.prototype._setKeyTableListener = function () {
      var h = this;
      this.s.dt.on("key-focus.dt.dtfc", function (t, s, e) {
        var i,
          ...
          o,
          r = D(e.node()).offset(),
          d = D(D(h.s.dt.table().node()).closest("div.dataTables_scrollBody"));
        0 < h.c.left &&
          ((i = (l = D(h.s.dt.column(h.c.left - 1).header())).offset()),
          (l = l.outerWidth()),
          r.left < i.left + l &&
            ((o = d.scrollLeft()), d.scrollLeft(o - (i.left + l - r.left)))),
          0 < h.c.right &&
            ((i = h.s.dt.columns().data().toArray().length),
            (l = D(e.node()).outerWidth()),
            (e = D(h.s.dt.column(i - h.c.right).header()).offset()),
            r.left + l > e.left &&
              ((o = d.scrollLeft()),
        ...
        this.s.dt.on("column-visibility.dt.dtfc", function (t, s, e, i, l) {
          l &&
            !s.bDestroying &&
            setTimeout(function () {
              h._addStyles();
    ...
    (l.defaults = { i18n: { button: "FixedColumns" }, left: 1, right: 0 });
  /*! FixedColumns 4.3.0
   * © SpryMedia Ltd - datatables.net/license
   */ var e = l;
  function l(t, s) {
    ...
    if (i && i.versionCheck && i.versionCheck("1.10.0"))
      return (
        (t = new i.Api(t)),
        (this.classes = D.extend(!0, {}, l.classes)),
        (this.c = D.extend(!0, {}, l.defaults, s)),
        (s && void 0 !== s.left) ||
  ...
  (t = $),
    (i = (D = t).fn.dataTable),
    ($.fn.dataTable.FixedColumns = e),
    ($.fn.DataTable.FixedColumns = e);
  var t = DataTable.Api.register;
  function o(t, s) {
    void 0 === s && (s = null);
    (t = new DataTable.Api(t)),
      (s = s || t.init().fixedColumns || DataTable.defaults.fixedColumns);
    new e(t, s);
  }
  t("fixedColumns()", function () {
    return this;
  }),
    t("fixedColumns().left()", function (t) {
      var s = this.context[0];
      return void 0 !== t
        ? (s._fixedColumns.left(t), this)
        : s._fixedColumns.left();
    }),
    t("fixedColumns().right()", function (t) {
      var s = this.context[0];
      return void 0 !== t
    ...
    (DataTable.ext.buttons.fixedColumns = {
      action: function (t, s, e, i) {
        $(e).attr("active")
          ? ($(e).removeAttr("active").removeClass("active"),
            s.fixedColumns().left(0),
            s.fixedColumns().right(0))
          : ($(e).attr("active", "true").addClass("active"),
            s.fixedColumns().left(i.config.left),
            s.fixedColumns().right(i.config.right));
      },
      config: { left: 1, right: 0 },
      init: function (t, s, e) {
        void 0 === t.settings()[0]._fixedColumns && o(t.settings(), e),
          $(s).attr("active", "true").addClass("active"),
          t
            .button(s)
            .text(
              e.text ||
    ...
    $(document).on("plugin-init.dt", function (t, s) {
      "dt" !== t.namespace ||
        (!s.oInit.fixedColumns && !DataTable.defaults.fixedColumns) ||
        s._fixedColumns ||
        o(s, null);
    });
})();
