...
!(function (d, e) {
  ...
  (e.createBarChart = function (e, t) {
    var a = d(e).data("colors"),
      a = a ? a.split(",") : i.concat(),
      l = new britecharts.miniTooltip(),
    ...
    (e.createHorizontalBarChart = function (e, t) {
      var a = d(e).data("colors"),
        ...
        e = d3.select(e),
        n = !!e.node() && e.node().getBoundingClientRect().width,
        u = !!e.node() && e.node().getBoundingClientRect().height;
      l
        .colorSchema(a)
        .isAnimated(!0)
        .isHorizontal(!0)
    ...
    (e.createDonutChart = function (e, t) {
      var a = d(e).data("colors"),
        a = a ? a.split(",") : i.concat(),
        l = britecharts.donut(),
        n = britecharts.legend();
      n.width(250).height(200).colorSchema(a).numberFormat("s"),
        l
          .height(300)
          ...
          .on("customMouseOver", function (e) {
            n.highlight(e.data.id);
          })
          .on("customMouseOut", function () {
            n.clearHighlight();
          }),
        d3.select(e).datum(t).call(l),
        d3.select(".legend-chart-container").datum(t).call(n);
    }),
    (e.createBrushChart = function (e, t) {
      var e = d3.select(e),
        a = britecharts.brush(),
        l = !!e.node() && e.node().getBoundingClientRect().width;
      a
        .height(320)
        .width(l)
        .on("customBrushStart", function (e) {
          ...
          console.log("Start date = " + t(e[0])),
            console.log("End date = " + t(e[1]));
        })
        .on("customBrushEnd", function (e) {
          console.log("rounded extent", e);
        }),
        e.datum(t).call(a),
        a.dateRange(["9/15/2015", "1/25/2016"]);
    }),
