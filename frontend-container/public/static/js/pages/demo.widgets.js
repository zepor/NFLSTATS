    ...
    ($(document).ready(function () {
      ...
      var o = ["#3688fc"],
        ...
        o =
          ...
          ["#0acf97"]),
        s =
          ((a = $("#profit-spark").data("colors")) && (o = a.split(",")),
          {
        ...
        e = {
          ...
          markers: { size: 0 },
          colors: (o = (a = $("#spark1").data("colors")) ? a.split(",") : o),
        },
        o = ["#34bfa3"],
        s = {
          ...
          markers: { size: 0 },
          colors: (o = (a = $("#spark2").data("colors")) ? a.split(",") : o),
        },
        o = ["#f4516c"],
        l = {
          chart: { type: "line", height: 100, sparkline: { enabled: !0 } },
          ...
          stroke: { width: 4, curve: "smooth" },
          markers: { size: 0 },
          colors: (o = (a = $("#spark3").data("colors")) ? a.split(",") : o),
        },
        o = ["#00c5dc"],
        a = {
          chart: { type: "bar", height: 100, sparkline: { enabled: !0 } },
          ...
          stroke: { width: 3, curve: "smooth" },
          markers: { size: 0 },
          colors: (o = (a = $("#spark4").data("colors")) ? a.split(",") : o),
        };
      new ApexCharts(document.querySelector("#spark1"), e).render(),
        new ApexCharts(document.querySelector("#spark2"), s).render(),
        new ApexCharts(document.querySelector("#spark3"), l).render(),
        new ApexCharts(document.querySelector("#spark4"), a).render();
    }),
    ["#727cf5"]),
