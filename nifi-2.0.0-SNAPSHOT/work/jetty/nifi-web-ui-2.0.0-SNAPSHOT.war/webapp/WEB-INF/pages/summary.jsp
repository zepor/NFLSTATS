...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/nf-summary-all.css?2.0.0-SNAPSHOT" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?2.0.0-SNAPSHOT" type="text/css" />
        ...
        <link rel="stylesheet" href="js/jquery/nfeditor/languages/nfpr.css?2.0.0-SNAPSHOT" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/summary/nf-summary-all.js?2.0.0-SNAPSHOT"></script>
