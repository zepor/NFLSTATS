...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/nf-counters-all.css?2.0.0-SNAPSHOT" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?2.0.0-SNAPSHOT" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/counters/nf-counters-all.js?2.0.0-SNAPSHOT"></script>
    </head>
    <body>
