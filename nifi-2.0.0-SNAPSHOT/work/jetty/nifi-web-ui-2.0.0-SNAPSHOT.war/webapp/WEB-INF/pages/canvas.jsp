...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/nf-canvas-all.css?2.0.0-SNAPSHOT" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?2.0.0-SNAPSHOT" type="text/css" />
        ...
        <link rel="stylesheet" href="js/jquery/nfeditor/jquery.nfeditor.css?2.0.0-SNAPSHOT" type="text/css" />
        <link rel="stylesheet" href="js/jquery/nfeditor/languages/nfeditor.css?2.0.0-SNAPSHOT" type="text/css" />
        ...
        <link rel="stylesheet" href="js/jquery/propertytable/jquery.propertytable.css?2.0.0-SNAPSHOT" type="text/css" />
        <link rel="stylesheet" href="js/jquery/tagcloud/jquery.tagcloud.css?2.0.0-SNAPSHOT" type="text/css" />
        <link rel="stylesheet" href="js/jquery/modal/jquery.modal.css?2.0.0-SNAPSHOT" type="text/css" />
        <link rel="stylesheet" href="js/jquery/statusbar/jquery.statusbar.css?2.0.0-SNAPSHOT" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/canvas/nf-ng-canvas-namespace.js?2.0.0-SNAPSHOT"></script>
        <script type="text/javascript" src="js/nf/canvas/nf-canvas-all.js?2.0.0-SNAPSHOT"></script>
        ...
        <script type="text/javascript" src="js/jquery/tagcloud/jquery.tagcloud.js?2.0.0-SNAPSHOT"></script>
        <script type="text/javascript" src="js/jquery/statusbar/jquery.statusbar.js?2.0.0-SNAPSHOT"></script>
    </head>
