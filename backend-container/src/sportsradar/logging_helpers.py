"""Configure logging for the sportsradar package."""
import logging
...
def get_logger(name: str):
    """Helper function to append 'sportsradar' to logger name and return logger."""
    return logging.getLogger(f"sportsradar.{name}")


def configure_root_logger(logfile: str | None = None, loglevel: str = "INFO"):
    """Configure the root logger for the sportsradar.
