...
#   ('-o', 'transactions-v7.0.py')
#
# Command line arguments:
#   transactions-v7.0.xsd
#
# Command line:
#   /home/zepor/.local/bin/generateDS -o "transactions-v7.0.py" transactions-v7.0.xsd
#
...
#
class transactions(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, transaction=None, gds_collector_=None, **kwargs_):
        ...
        self.transaction_nsprefix_ = "t"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, transactions)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if transactions.subclass:
            return transactions.subclass(*args_, **kwargs_)
        else:
            return transactions(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='transactions', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('transactions')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'transactions':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='transactions')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='transactions', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='transactions'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='transactions', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class referenceType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='referenceType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='referenceType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class venueType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='venueType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='venueType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='teamType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='teamType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class references(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='references', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='references'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='references', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class franchise(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='franchise', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='franchise'):
        ...
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='franchise', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='teamColorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='teamColorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='teamColorsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamColorsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='teamColorsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class transactionType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, number=None, status=None, description=None, code=None, date=None, voided_date=None, sequence=None, year=None, player=None, player_status=None, from_team=None, to_team=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.voided_date = _cast(None, voided_date)
        self.voided_date_nsprefix_ = None
        ...
        self.player_status_nsprefix_ = None
        self.from_team = from_team
        self.from_team_nsprefix_ = None
        self.to_team = to_team
        self.to_team_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_date(self, date):
        self.date = date
    def get_voided_date(self):
        return self.voided_date
    def set_voided_date(self, voided_date):
    ...
    def has__content(self):
        if (
            ...
            self.player_status is not None or
            self.from_team is not None or
            self.to_team is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='transactionType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='transactionType'):
        ...
        if self.voided_date is not None and 'voided_date' not in already_processed:
            already_processed.add('voided_date')
            outfile.write(' voided_date=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.voided_date), input_name='voided_date')), ))
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='transactionType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.player_status is not None:
            namespaceprefix_ = self.player_status_nsprefix_ + ':' if (UseCapturedNS_ and self.player_status_nsprefix_) else ''
            self.player_status.export(outfile, level, namespaceprefix_, namespacedef_='', name_='player_status', pretty_print=pretty_print)
        if self.from_team is not None:
            namespaceprefix_ = self.from_team_nsprefix_ + ':' if (UseCapturedNS_ and self.from_team_nsprefix_) else ''
            self.from_team.export(outfile, level, namespaceprefix_, namespacedef_='', name_='from_team', pretty_print=pretty_print)
        if self.to_team is not None:
            namespaceprefix_ = self.to_team_nsprefix_ + ':' if (UseCapturedNS_ and self.to_team_nsprefix_) else ''
            self.to_team.export(outfile, level, namespaceprefix_, namespacedef_='', name_='to_team', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'date' not in already_processed:
            already_processed.add('date')
            self.date = value
        value = find_attr_value_('voided_date', node)
        if value is not None and 'voided_date' not in already_processed:
            already_processed.add('voided_date')
            self.voided_date = value
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        ...
        elif nodeName_ == 'player_status':
            obj_ = player_statusType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.player_status = obj_
            obj_.original_tagname_ = 'player_status'
        elif nodeName_ == 'from_team':
            obj_ = teamType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.from_team = obj_
            obj_.original_tagname_ = 'from_team'
        elif nodeName_ == 'to_team':
            obj_ = teamType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.to_team = obj_
            obj_.original_tagname_ = 'to_team'
...
class playerType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, college=None, id=None, sr_id=None, name=None, jersey=None, reference=None, position=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='playerType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='playerType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class player_statusType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, before=None, after=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.before = _cast(None, before)
        self.before_nsprefix_ = None
        self.after = _cast(None, after)
        self.after_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, player_statusType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if player_statusType.subclass:
            return player_statusType.subclass(*args_, **kwargs_)
        else:
            return player_statusType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='player_statusType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('player_statusType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'player_statusType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='player_statusType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='player_statusType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='player_statusType'):
        if self.before is not None and 'before' not in already_processed:
            already_processed.add('before')
            outfile.write(' before=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.before), input_name='before')), ))
        if self.after is not None and 'after' not in already_processed:
            already_processed.add('after')
            outfile.write(' after=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.after), input_name='after')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='player_statusType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        value = find_attr_value_('before', node)
        if value is not None and 'before' not in already_processed:
            already_processed.add('before')
            self.before = value
        value = find_attr_value_('after', node)
        if value is not None and 'after' not in already_processed:
            already_processed.add('after')
            self.after = value
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class player_statusType
...
class locationType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='locationType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='locationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class rgb_colorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='rgb_colorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"', name_='rgb_colorType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'transactions'
        rootClass = transactions
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:t="http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from transactions-v7.0 import *\n\n')
        sys.stdout.write('import transactions-v7.0 as model_\n\n')
...
NamespaceToDefMappings_ = {'http://feed.elasticstats.com/schema/football/transactions-v7.0.xsd': []}
