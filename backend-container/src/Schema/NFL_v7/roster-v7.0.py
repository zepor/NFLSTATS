...
#
# Generated Sat Dec 16 08:30:12 2023 by generateDS.py version 2.43.3.
...
#
# Command line:
#   /home/zepor/.local/bin/generateDS -o "roster-v7.0.py" roster-v7.0.xsd
#
...
class assignmentType(str, Enum):
    REFEREE='referee'
    UMPIRE='umpire'
    HEADLINESMAN='headlinesman'
    LINEJUDGE='linejudge'
    FIELDJUDGE='fieldjudge'
    SIDEJUDGE='sidejudge'
    DOWNJUDGE='downjudge'
    BACKJUDGE='backjudge'
    REPLAYOFFICIAL='replayofficial'
...
class categoryType19(str, Enum):
    PUNT_RETURN='punt_return'
    KICK_RETURN='kick_return'


class categoryType21(str, Enum):
...
class categoryType3(str, Enum):
    FIELD_GOAL='field_goal'
    EXTRA_POINT='extra_point'
    PUNT='punt'


class categoryType4(str, Enum):
    PASS='pass'
    RECEIVE='receive'
    RUSH='rush'
    TURNOVER='turnover'
...
class gameType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, id=None, sr_id=None, number=None, utc_offset=None, reference=None, scheduled=None, title=None, neutral_site=None, status=None, game_type=None, playoff_game_type=None, attendance=None, duration=None, coverage=None, clock=None, quarter=None, entry_mode=None, weather=None, summary=None, home=None, away=None, officials=None, gds_collector_=None, **kwargs_):
        ...
        self.weather_nsprefix_ = "r"
        self.summary = summary
        self.summary_nsprefix_ = "r"
        self.home = home
        self.home_nsprefix_ = "r"
        self.away = away
        self.away_nsprefix_ = "r"
        self.officials = officials
        self.officials_nsprefix_ = "r"
    ...
    def has__content(self):
        if (
            ...
            self.officials is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.officials is not None:
            namespaceprefix_ = self.officials_nsprefix_ + ':' if (UseCapturedNS_ and self.officials_nsprefix_) else ''
            self.officials.export(outfile, level, namespaceprefix_, namespacedef_='', name_='officials', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'weather':
            ...
            obj_ = teamRosterType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.home = obj_
        ...
        elif nodeName_ == 'officials':
            obj_ = officialsType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.officials = obj_
            obj_.original_tagname_ = 'officials'
# end class gameType


class teamRosterType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, id=None, sr_id=None, alias=None, name=None, market=None, founded=None, reference=None, coach=None, player=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        if coach is None:
            ...
            self.coach = coach
        self.coach_nsprefix_ = "r"
        if player is None:
            self.player = []
        else:
            self.player = player
        self.player_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, teamRosterType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if teamRosterType.subclass:
            return teamRosterType.subclass(*args_, **kwargs_)
        else:
            return teamRosterType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamRosterType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('teamRosterType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'teamRosterType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='teamRosterType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='teamRosterType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamRosterType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.id), input_name='id')), ))
        if self.sr_id is not None and 'sr_id' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamRosterType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class playerProfileType(GeneratedsSuper):
    ...
    def __init__(self, age=None, id=None, sr_id=None, name=None, jersey=None, reference=None, position=None, abbr_name=None, birth_date=None, birth_place=None, college=None, college_conf=None, first_name=None, height=None, high_school=None, last_name=None, preferred_name=None, rookie_year=None, status=None, weight=None, name_suffix=None, eligibility=None, draft=None, references=None, gds_collector_=None, **kwargs_):
        ...
        self.draft = draft
        self.draft_nsprefix_ = "r"
        self.references = references
        self.references_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playerProfileType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='playerProfileType'):
        if self.age is not None and 'age' not in already_processed:
            ...
            outfile.write(' age="%s"' % self.gds_format_integer(self.age, input_name='age'))
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.id), input_name='id')), ))
        if self.sr_id is not None and 'sr_id' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playerProfileType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.references is not None:
            ...
            self.references.export(outfile, level, namespaceprefix_='r:', namespacedef_='', name_='references', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'age' not in already_processed:
            already_processed.add('age')
            self.age = self.gds_parse_integer(value, node, 'age')
        value = find_attr_value_('id', node)
        if value is not None and 'id' not in already_processed:
            already_processed.add('id')
            self.id = value
...
class coachType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, id=None, full_name=None, first_name=None, last_name=None, position=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='coachType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='coachType'):
        ...
        if self.position is not None and 'position' not in already_processed:
            already_processed.add('position')
            outfile.write(' position=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.position), input_name='position')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='coachType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class officialType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, id=None, full_name=None, number=None, assignment=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.number_nsprefix_ = None
        self.assignment = _cast(None, assignment)
        self.assignment_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, officialType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if officialType.subclass:
            return officialType.subclass(*args_, **kwargs_)
        else:
            return officialType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def validate_assignmentType(self, value):
        # Validate type assignmentType, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
                return False
            value = value
            enumerations = ['referee', 'umpire', 'headlinesman', 'linejudge', 'fieldjudge', 'sidejudge', 'downjudge', 'backjudge', 'replayofficial']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on assignmentType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='officialType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('officialType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'officialType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='officialType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='officialType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='officialType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.id), input_name='id')), ))
        if self.full_name is not None and 'full_name' not in already_processed:
        ...
        if self.assignment is not None and 'assignment' not in already_processed:
            already_processed.add('assignment')
            outfile.write(' assignment=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.assignment), input_name='assignment')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='officialType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'number' not in already_processed:
            already_processed.add('number')
            self.number = value
        value = find_attr_value_('assignment', node)
        if value is not None and 'assignment' not in already_processed:
            already_processed.add('assignment')
            self.assignment = value
            self.validate_assignmentType(self.assignment)    # validate type assignmentType
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class officialType
...
class summaryType(GeneratedsSuper):
    ...
    def __init__(self, season=None, week=None, venue=None, home=None, away=None, gds_collector_=None, **kwargs_):
        ...
        self.ns_prefix_ = "r"
        self.season = season
        self.season_nsprefix_ = "r"
        self.week = week
        self.week_nsprefix_ = "r"
        self.venue = venue
        self.venue_nsprefix_ = "r"
        self.home = home
        self.home_nsprefix_ = "r"
        self.away = away
        self.away_nsprefix_ = "r"
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='summaryType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='summaryType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='summaryType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class fieldSituationType(GeneratedsSuper):
    ...
    def __init__(self, clock=None, down=None, yfd=None, possession=None, location=None, gds_collector_=None, **kwargs_):
        ...
        self.possession_nsprefix_ = "r"
        self.location = location
        self.location_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fieldSituationType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fieldSituationType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class fieldLocationType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fieldLocationType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fieldLocationType'):
        ...
        if self.reference is not None and 'reference' not in already_processed:
            already_processed.add('reference')
            outfile.write(' reference=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.reference), input_name='reference')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fieldLocationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class gameEventType(GeneratedsSuper):
    ...
    def __init__(self, type_=None, created_at=None, updated_at=None, id=None, sequence=None, reference=None, clock=None, wall_clock=None, deleted=None, source=None, description=None, alt_description=None, gds_collector_=None, **kwargs_):
        ...
        self.description_nsprefix_ = "r"
        self.alt_description = alt_description
        self.alt_description_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameEventType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameEventType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class basePlayType(GeneratedsSuper):
    ...
    def __init__(self, away_points=None, home_points=None, play_clock=None, scoring_play=None, goaltogo=None, created_at=None, updated_at=None, id=None, sequence=None, reference=None, clock=None, wall_clock=None, deleted=None, source=None, type_=None, start_situation=None, end_situation=None, description=None, alt_description=None, scoring_description=None, extensiontype_=None, gds_collector_=None, **kwargs_):
        ...
        self.start_situation_nsprefix_ = "r"
        self.end_situation = end_situation
        self.end_situation_nsprefix_ = "r"
        self.description = description
        self.description_nsprefix_ = "r"
        self.alt_description = alt_description
        self.alt_description_nsprefix_ = "r"
        self.scoring_description = scoring_description
        self.scoring_description_nsprefix_ = "r"
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='basePlayType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='basePlayType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class gamePlayType(basePlayType):
    ...
    def __init__(self, away_points=None, home_points=None, play_clock=None, scoring_play=None, goaltogo=None, created_at=None, updated_at=None, id=None, sequence=None, reference=None, clock=None, wall_clock=None, deleted=None, source=None, type_=None, start_situation=None, end_situation=None, description=None, alt_description=None, scoring_description=None, drive_info=None, score=None, statistics=None, gds_collector_=None, **kwargs_):
        ...
        self.drive_info_nsprefix_ = "r"
        self.score = score
        self.score_nsprefix_ = "r"
        self.statistics = statistics
        self.statistics_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gamePlayType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gamePlayType', fromsubclass_=False, pretty_print=True):
...
class gameDriveType(GeneratedsSuper):
    ...
    def __init__(self, id=None, sequence=None, start_reason=None, end_reason=None, duration=None, first_downs=None, gain=None, inside_20=None, penalty_yards=None, play_count=None, scoring_drive=None, created_at=None, updated_at=None, event=None, play=None, gds_collector_=None, **kwargs_):
        ...
        if event is None:
            ...
            self.event = event
        self.event_nsprefix_ = "r"
        if play is None:
            self.play = []
        else:
            self.play = play
        self.play_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameDriveType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='gameDriveType'):
        ...
        if self.updated_at is not None and 'updated_at' not in already_processed:
            already_processed.add('updated_at')
            outfile.write(' updated_at=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.updated_at), input_name='updated_at')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameDriveType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class playScoreType(GeneratedsSuper):
    ...
    def __init__(self, clock=None, sequence=None, away_points=None, home_points=None, points=None, points_after_play=None, gds_collector_=None, **kwargs_):
        ...
        self.points_after_play_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playScoreType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playScoreType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class playStatisticsType(GeneratedsSuper):
    ...
    def __init__(self, timeout=None, misc=None, pass_=None, receive=None, rush=None, kick=None, punt=None, field_goal=None, extra_point=None, penalty=None, fumble=None, return_=None, block=None, defense=None, conversion=None, defense_conversion=None, down_conversion=None, first_down=None, gds_collector_=None, **kwargs_):
        ...
        self.timeout_nsprefix_ = "r"
        if misc is None:
            self.misc = []
        else:
            self.misc = misc
        self.misc_nsprefix_ = "r"
        if pass_ is None:
            self.pass_ = []
        else:
            self.pass_ = pass_
        self.pass__nsprefix_ = "r"
        if receive is None:
            self.receive = []
        else:
            self.receive = receive
        self.receive_nsprefix_ = "r"
        if rush is None:
            self.rush = []
        else:
            self.rush = rush
        self.rush_nsprefix_ = "r"
        if kick is None:
            self.kick = []
        else:
            self.kick = kick
        self.kick_nsprefix_ = "r"
        if punt is None:
            self.punt = []
        else:
            self.punt = punt
        self.punt_nsprefix_ = "r"
        if field_goal is None:
            self.field_goal = []
        else:
            self.field_goal = field_goal
        self.field_goal_nsprefix_ = "r"
        if extra_point is None:
            self.extra_point = []
        else:
            self.extra_point = extra_point
        self.extra_point_nsprefix_ = "r"
        if penalty is None:
            self.penalty = []
        else:
            self.penalty = penalty
        self.penalty_nsprefix_ = "r"
        if fumble is None:
            self.fumble = []
        else:
            self.fumble = fumble
        self.fumble_nsprefix_ = "r"
        if return_ is None:
            self.return_ = []
        else:
            self.return_ = return_
        self.return__nsprefix_ = "r"
        if block is None:
            self.block = []
        else:
            self.block = block
        self.block_nsprefix_ = "r"
        if defense is None:
            self.defense = []
        else:
            self.defense = defense
        self.defense_nsprefix_ = "r"
        if conversion is None:
            self.conversion = []
        else:
            self.conversion = conversion
        self.conversion_nsprefix_ = "r"
        if defense_conversion is None:
            self.defense_conversion = []
        else:
            self.defense_conversion = defense_conversion
        self.defense_conversion_nsprefix_ = "r"
        if down_conversion is None:
            self.down_conversion = []
        else:
            self.down_conversion = down_conversion
        self.down_conversion_nsprefix_ = "r"
        if first_down is None:
            self.first_down = []
        else:
            self.first_down = first_down
        self.first_down_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playStatisticsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='playStatisticsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playStatisticsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class basePlayStatisticType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='basePlayStatisticType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='basePlayStatisticType'):
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            if ":" not in self.extensiontype_:
                ...
                outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='basePlayStatisticType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class extPlayStatisticsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extPlayStatisticsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='extPlayStatisticsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extPlayStatisticsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'timeout':
            obj_ = timeoutType7.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.timeout.append(obj_)
            obj_.original_tagname_ = 'timeout'
        elif nodeName_ == 'misc':
            obj_ = miscType8.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.misc.append(obj_)
            obj_.original_tagname_ = 'misc'
        elif nodeName_ == 'pass':
            obj_ = passType9.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.pass_.append(obj_)
            obj_.original_tagname_ = 'pass'
        elif nodeName_ == 'receive':
            obj_ = receiveType10.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.receive.append(obj_)
            obj_.original_tagname_ = 'receive'
        elif nodeName_ == 'rush':
            obj_ = rushType11.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.rush.append(obj_)
            obj_.original_tagname_ = 'rush'
        elif nodeName_ == 'kick':
            obj_ = kickType12.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.kick.append(obj_)
            obj_.original_tagname_ = 'kick'
        elif nodeName_ == 'punt':
            obj_ = puntType13.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.punt.append(obj_)
            obj_.original_tagname_ = 'punt'
        elif nodeName_ == 'field_goal':
            obj_ = field_goalType14.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.field_goal.append(obj_)
            obj_.original_tagname_ = 'field_goal'
        elif nodeName_ == 'extra_point':
            obj_ = extra_pointType15.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.extra_point.append(obj_)
            obj_.original_tagname_ = 'extra_point'
        elif nodeName_ == 'penalty':
            obj_ = penaltyType16.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.penalty.append(obj_)
            obj_.original_tagname_ = 'penalty'
        elif nodeName_ == 'fumble':
            obj_ = fumbleType17.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.fumble.append(obj_)
            obj_.original_tagname_ = 'fumble'
        elif nodeName_ == 'return':
            obj_ = returnType18.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.return_.append(obj_)
            obj_.original_tagname_ = 'return'
        elif nodeName_ == 'block':
            obj_ = blockType20.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.block.append(obj_)
            obj_.original_tagname_ = 'block'
        elif nodeName_ == 'defense':
            obj_ = defenseType22.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.defense.append(obj_)
            obj_.original_tagname_ = 'defense'
        elif nodeName_ == 'conversion':
            obj_ = conversionType23.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.conversion.append(obj_)
            obj_.original_tagname_ = 'conversion'
        elif nodeName_ == 'defense_conversion':
            obj_ = defense_conversionType25.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.defense_conversion.append(obj_)
            obj_.original_tagname_ = 'defense_conversion'
        elif nodeName_ == 'down_conversion':
            obj_ = down_conversionType27.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.down_conversion.append(obj_)
            obj_.original_tagname_ = 'down_conversion'
        elif nodeName_ == 'first_down':
            obj_ = first_downType28.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.first_down.append(obj_)
            obj_.original_tagname_ = 'first_down'
...
class extGamePlayType(basePlayType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extGamePlayType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extGamePlayType', fromsubclass_=False, pretty_print=True):
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'drive-info':
            obj_ = drive_infoType30.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.drive_info = obj_
            obj_.original_tagname_ = 'drive-info'
        elif nodeName_ == 'score':
...
class extGameDriveType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extGameDriveType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='extGameDriveType'):
        ...
        if self.updated_at is not None and 'updated_at' not in already_processed:
            already_processed.add('updated_at')
            outfile.write(' updated_at=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.updated_at), input_name='updated_at')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extGameDriveType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class playDetailsType(GeneratedsSuper):
    ...
    def __init__(self, safety=None, direction=None, category=None, description_attr=None, sequence=None, yards=None, result=None, onside=None, sack_split=None, reason_missed=None, first_touch=None, no_attempt=None, description=None, start_location=None, end_location=None, penalty=None, recovery=None, review=None, players=None, gds_collector_=None, **kwargs_):
        ...
        self.start_location_nsprefix_ = "r"
        self.end_location = end_location
        self.end_location_nsprefix_ = "r"
        self.penalty = penalty
        self.penalty_nsprefix_ = "r"
        self.recovery = recovery
        self.recovery_nsprefix_ = "r"
        self.review = review
        self.review_nsprefix_ = "r"
        self.players = players
        self.players_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playDetailsType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playDetailsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'description':
            ...
            obj_ = penaltyType31.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.penalty = obj_
            obj_.original_tagname_ = 'penalty'
...
class extFieldLocationType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extFieldLocationType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='extFieldLocationType'):
        ...
        if self.yardline is not None and 'yardline' not in already_processed:
            already_processed.add('yardline')
            outfile.write(' yardline="%s"' % self.gds_format_integer(self.yardline, input_name='yardline'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extFieldLocationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class gamePlayDetailsType(basePlayType):
    ...
    def __init__(self, away_points=None, home_points=None, play_clock=None, scoring_play=None, goaltogo=None, created_at=None, updated_at=None, id=None, sequence=None, reference=None, clock=None, wall_clock=None, deleted=None, source=None, type_=None, start_situation=None, end_situation=None, description=None, alt_description=None, scoring_description=None, play_action=None, run_pass_option=None, qb_at_snap=None, fake_punt=None, fake_field_goal=None, players_rushed=None, men_in_box=None, play_direction=None, left_tightends=None, right_tightends=None, hash_mark=None, screen_pass=None, pocket_location=None, blitz=None, huddle=None, pass_route=None, running_lane=None, drive_info=None, score=None, quarter=None, overtime=None, statistics=None, details=None, gds_collector_=None, **kwargs_):
        ...
        self.score_nsprefix_ = "r"
        self.quarter = quarter
        self.quarter_nsprefix_ = "r"
        self.overtime = overtime
        self.overtime_nsprefix_ = "r"
        self.statistics = statistics
        self.statistics_nsprefix_ = "r"
        self.details = details
        self.details_nsprefix_ = "r"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gamePlayDetailsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='gamePlayDetailsType'):
        ...
        if self.running_lane is not None and 'running_lane' not in already_processed:
            already_processed.add('running_lane')
            outfile.write(' running_lane="%s"' % self.gds_format_integer(self.running_lane, input_name='running_lane'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gamePlayDetailsType', fromsubclass_=False, pretty_print=True):
...
class gameDetailsDriveType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameDetailsDriveType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='gameDetailsDriveType'):
        ...
        if self.updated_at is not None and 'updated_at' not in already_processed:
            already_processed.add('updated_at')
            outfile.write(' updated_at=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.updated_at), input_name='updated_at')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameDetailsDriveType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class coinTossType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='coinTossType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='coinTossType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class weatherType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='weatherType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='weatherType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class referenceType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='referenceType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='referenceType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class venueType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='venueType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='venueType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamType'):
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            if ":" not in self.extensiontype_:
                ...
                outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class references(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='references', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='references'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='references', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class franchise(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='franchise', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='franchise'):
        ...
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='franchise', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamColorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamColorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamColorsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamColorsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='teamColorsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class officialsType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, official=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, officialsType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if officialsType.subclass:
            return officialsType.subclass(*args_, **kwargs_)
        else:
            return officialsType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='officialsType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('officialsType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'officialsType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='officialsType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='officialsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='officialsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='officialsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        pass
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'official':
            obj_ = officialType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.official.append(obj_)
            obj_.original_tagname_ = 'official'
# end class officialsType
...
class draftType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='draftType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='draftType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class seasonType(GeneratedsSuper):
    ...
    def set_type(self, type_):
        self.type_ = type_
    def validate_typeType34(self, value):
        # Validate type typeType34, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on typeType34' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='seasonType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='seasonType'):
        ...
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='seasonType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'type' not in already_processed:
            already_processed.add('type')
            self.type_ = value
            self.validate_typeType34(self.type_)    # validate type typeType34
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
...
class weekType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='weekType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='weekType'):
        ...
        if self.title is not None and 'title' not in already_processed:
            already_processed.add('title')
            outfile.write(' title=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.title), input_name='title')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='weekType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class recordType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='recordType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='recordType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class drive_infoType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='drive-infoType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='drive-infoType'):
        ...
        if self.play_count is not None and 'play_count' not in already_processed:
            already_processed.add('play_count')
            outfile.write(' play_count="%s"' % self.gds_format_integer(self.play_count, input_name='play_count'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='drive-infoType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class points_after_playType(GeneratedsSuper):
    ...
    def validate_typeType2(self, value):
        # Validate type typeType2, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='points-after-playType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='points-after-playType'):
        ...
        if self.source is not None and 'source' not in already_processed:
            already_processed.add('source')
            outfile.write(' source=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.source), input_name='source')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='points-after-playType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class timeoutType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='timeoutType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='timeoutType', fromsubclass_=False, pretty_print=True):
...
class miscType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='miscType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='miscType', fromsubclass_=False, pretty_print=True):
...
class passType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='passType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='passType', fromsubclass_=False, pretty_print=True):
...
class receiveType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='receiveType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='receiveType'):
        ...
        if self.goaltogo is not None and 'goaltogo' not in already_processed:
            already_processed.add('goaltogo')
            outfile.write(' goaltogo="%s"' % self.gds_format_integer(self.goaltogo, input_name='goaltogo'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='receiveType', fromsubclass_=False, pretty_print=True):
...
class rushType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='rushType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='rushType', fromsubclass_=False, pretty_print=True):
...
class kickType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='kickType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='kickType', fromsubclass_=False, pretty_print=True):
...
class puntType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='puntType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='puntType'):
        ...
        if self.safety is not None and 'safety' not in already_processed:
            already_processed.add('safety')
            outfile.write(' safety="%s"' % self.gds_format_integer(self.safety, input_name='safety'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='puntType', fromsubclass_=False, pretty_print=True):
...
class field_goalType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='field_goalType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='field_goalType', fromsubclass_=False, pretty_print=True):
...
class extra_pointType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extra_pointType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extra_pointType', fromsubclass_=False, pretty_print=True):
...
class penaltyType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='penaltyType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='penaltyType'):
        ...
        if self.yards is not None and 'yards' not in already_processed:
            already_processed.add('yards')
            outfile.write(' yards="%s"' % self.gds_format_integer(self.yards, input_name='yards'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='penaltyType', fromsubclass_=False, pretty_print=True):
...
class fumbleType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fumbleType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fumbleType', fromsubclass_=False, pretty_print=True):
...
class returnType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='returnType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='returnType'):
        ...
        if self.play_category is not None and 'play_category' not in already_processed:
            already_processed.add('play_category')
            outfile.write(' play_category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.play_category), input_name='play_category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='returnType', fromsubclass_=False, pretty_print=True):
...
class blockType(basePlayStatisticType):
    ...
    def set_category(self, category):
        self.category = category
    def validate_categoryType3(self, value):
        # Validate type categoryType3, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on categoryType3' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='blockType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='blockType'):
        ...
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='blockType', fromsubclass_=False, pretty_print=True):
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'category' not in already_processed:
            already_processed.add('category')
            self.category = value
            self.validate_categoryType3(self.category)    # validate type categoryType3
...
class defenseType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defenseType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='defenseType'):
        ...
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defenseType', fromsubclass_=False, pretty_print=True):
...
class conversionType(basePlayStatisticType):
    ...
    def set_category(self, category):
        self.category = category
    def validate_categoryType4(self, value):
        # Validate type categoryType4, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on categoryType4' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='conversionType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='conversionType'):
        ...
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='conversionType', fromsubclass_=False, pretty_print=True):
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'category' not in already_processed:
            already_processed.add('category')
            self.category = value
            self.validate_categoryType4(self.category)    # validate type categoryType4
...
class defense_conversionType(basePlayStatisticType):
    ...
    def set_category(self, category):
        self.category = category
    def validate_categoryType5(self, value):
        # Validate type categoryType5, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on categoryType5' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defense_conversionType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='defense_conversionType'):
        ...
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defense_conversionType', fromsubclass_=False, pretty_print=True):
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'category' not in already_processed:
            already_processed.add('category')
            self.category = value
            self.validate_categoryType5(self.category)    # validate type categoryType5
...
class down_conversionType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='down_conversionType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='down_conversionType'):
        ...
        if self.complete is not None and 'complete' not in already_processed:
            already_processed.add('complete')
            outfile.write(' complete="%s"' % self.gds_format_integer(self.complete, input_name='complete'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='down_conversionType', fromsubclass_=False, pretty_print=True):
...
class first_downType(basePlayStatisticType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='first_downType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='first_downType'):
        ...
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='first_downType', fromsubclass_=False, pretty_print=True):
...
class playerType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playerType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='playerType'):
        ...
        if self.position is not None and 'position' not in already_processed:
            already_processed.add('position')
            outfile.write(' position=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.position), input_name='position')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playerType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class timeoutType7(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, description=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("timeoutType7"), self).__init__(nullified, team, player,  **kwargs_)
        self.description = _cast(None, description)
        self.description_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, timeoutType7)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if timeoutType7.subclass:
            return timeoutType7.subclass(*args_, **kwargs_)
        else:
            return timeoutType7(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(timeoutType7, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='timeoutType7', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('timeoutType7')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'timeoutType7':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='timeoutType7')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='timeoutType7', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='timeoutType7'):
        super(timeoutType7, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='timeoutType7')
        if self.description is not None and 'description' not in already_processed:
            already_processed.add('description')
            outfile.write(' description=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.description), input_name='description')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='timeoutType7', fromsubclass_=False, pretty_print=True):
        super(timeoutType7, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'description' not in already_processed:
            already_processed.add('description')
            self.description = value
        super(timeoutType7, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(timeoutType7, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class timeoutType7


class miscType8(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, yards=None, touchdown=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("miscType8"), self).__init__(nullified, team, player,  **kwargs_)
        self.yards = _cast(int, yards)
        self.yards_nsprefix_ = None
        self.touchdown = _cast(int, touchdown)
        self.touchdown_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, miscType8)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if miscType8.subclass:
            return miscType8.subclass(*args_, **kwargs_)
        else:
            return miscType8(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(miscType8, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='miscType8', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('miscType8')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'miscType8':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='miscType8')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='miscType8', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='miscType8'):
        super(miscType8, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='miscType8')
        if self.yards is not None and 'yards' not in already_processed:
            already_processed.add('yards')
            outfile.write(' yards="%s"' % self.gds_format_integer(self.yards, input_name='yards'))
        if self.touchdown is not None and 'touchdown' not in already_processed:
            already_processed.add('touchdown')
            outfile.write(' touchdown="%s"' % self.gds_format_integer(self.touchdown, input_name='touchdown'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='miscType8', fromsubclass_=False, pretty_print=True):
        super(miscType8, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'touchdown' not in already_processed:
            already_processed.add('touchdown')
            self.touchdown = self.gds_parse_integer(value, node, 'touchdown')
        super(miscType8, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(miscType8, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class miscType8


class passType9(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, complete=None, yards=None, att_yards=None, interception=None, firstdown=None, touchdown=None, sack=None, sack_yards=None, inside_20=None, goaltogo=None, safety=None, incompletion_type=None, blitz=None, hurry=None, knockdown=None, pocket_time=None, batted_pass=None, on_target_throw=None, int_touchdown=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("passType9"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.complete = _cast(int, complete)
        self.complete_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, passType9)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if passType9.subclass:
            return passType9.subclass(*args_, **kwargs_)
        else:
            return passType9(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(passType9, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='passType9', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('passType9')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'passType9':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='passType9')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='passType9', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='passType9'):
        super(passType9, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='passType9')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.complete is not None and 'complete' not in already_processed:
        ...
        if self.int_touchdown is not None and 'int_touchdown' not in already_processed:
            already_processed.add('int_touchdown')
            outfile.write(' int_touchdown="%s"' % self.gds_format_integer(self.int_touchdown, input_name='int_touchdown'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='passType9', fromsubclass_=False, pretty_print=True):
        super(passType9, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'int_touchdown' not in already_processed:
            already_processed.add('int_touchdown')
            self.int_touchdown = self.gds_parse_integer(value, node, 'int_touchdown')
        super(passType9, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(passType9, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class passType9


class receiveType10(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, firstdown=None, touchdown=None, safety=None, target=None, reception=None, yards=None, yards_after_catch=None, fumble=None, dropped=None, inside_20=None, goaltogo=None, broken_tackles=None, catchable=None, yards_after_contact=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("receiveType10"), self).__init__(nullified, team, player,  **kwargs_)
        self.firstdown = _cast(int, firstdown)
        self.firstdown_nsprefix_ = None
        self.touchdown = _cast(int, touchdown)
        self.touchdown_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, receiveType10)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if receiveType10.subclass:
            return receiveType10.subclass(*args_, **kwargs_)
        else:
            return receiveType10(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(receiveType10, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='receiveType10', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('receiveType10')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'receiveType10':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='receiveType10')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='receiveType10', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='receiveType10'):
        super(receiveType10, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='receiveType10')
        if self.firstdown is not None and 'firstdown' not in already_processed:
            already_processed.add('firstdown')
            outfile.write(' firstdown="%s"' % self.gds_format_integer(self.firstdown, input_name='firstdown'))
        if self.touchdown is not None and 'touchdown' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='receiveType10', fromsubclass_=False, pretty_print=True):
        super(receiveType10, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(receiveType10, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(receiveType10, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class receiveType10


class rushType11(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, yards=None, touchdown=None, firstdown=None, safety=None, fumble=None, inside_20=None, goaltogo=None, lateral=None, tlost=None, tlost_yards=None, broken_tackles=None, kneel_down=None, scramble=None, yards_after_contact=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("rushType11"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.yards = _cast(int, yards)
        self.yards_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, rushType11)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if rushType11.subclass:
            return rushType11.subclass(*args_, **kwargs_)
        else:
            return rushType11(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(rushType11, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='rushType11', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('rushType11')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'rushType11':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='rushType11')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='rushType11', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='rushType11'):
        super(rushType11, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='rushType11')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.yards is not None and 'yards' not in already_processed:
        ...
        if self.yards_after_contact is not None and 'yards_after_contact' not in already_processed:
            already_processed.add('yards_after_contact')
            outfile.write(' yards_after_contact="%s"' % self.gds_format_integer(self.yards_after_contact, input_name='yards_after_contact'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='rushType11', fromsubclass_=False, pretty_print=True):
        super(rushType11, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'yards_after_contact' not in already_processed:
            already_processed.add('yards_after_contact')
            self.yards_after_contact = self.gds_parse_integer(value, node, 'yards_after_contact')
        super(rushType11, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(rushType11, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class rushType11


class kickType12(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, yards=None, net_yards=None, gross_yards=None, inside_20=None, endzone=None, touchback=None, own_rec=None, own_rec_td=None, onside_attempt=None, onside_success=None, squib_kick=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("kickType12"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.yards = _cast(int, yards)
        self.yards_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, kickType12)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if kickType12.subclass:
            return kickType12.subclass(*args_, **kwargs_)
        else:
            return kickType12(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(kickType12, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='kickType12', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('kickType12')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'kickType12':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='kickType12')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='kickType12', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='kickType12'):
        super(kickType12, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='kickType12')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.yards is not None and 'yards' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='kickType12', fromsubclass_=False, pretty_print=True):
        super(kickType12, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(kickType12, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(kickType12, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class kickType12


class puntType13(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, yards=None, net_yards=None, inside_20=None, endzone=None, touchback=None, blocked=None, safety=None, hang_time=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("puntType13"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.yards = _cast(int, yards)
        self.yards_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, puntType13)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if puntType13.subclass:
            return puntType13.subclass(*args_, **kwargs_)
        else:
            return puntType13(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(puntType13, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='puntType13', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('puntType13')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'puntType13':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='puntType13')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='puntType13', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='puntType13'):
        super(puntType13, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='puntType13')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.yards is not None and 'yards' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='puntType13', fromsubclass_=False, pretty_print=True):
        super(puntType13, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(puntType13, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(puntType13, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class puntType13


class field_goalType14(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, att_yards=None, yards=None, missed=None, made=None, blocked=None, returned=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("field_goalType14"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.att_yards = _cast(int, att_yards)
        self.att_yards_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, field_goalType14)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if field_goalType14.subclass:
            return field_goalType14.subclass(*args_, **kwargs_)
        else:
            return field_goalType14(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(field_goalType14, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='field_goalType14', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('field_goalType14')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'field_goalType14':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='field_goalType14')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='field_goalType14', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='field_goalType14'):
        super(field_goalType14, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='field_goalType14')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.att_yards is not None and 'att_yards' not in already_processed:
        ...
        if self.returned is not None and 'returned' not in already_processed:
            already_processed.add('returned')
            outfile.write(' returned="%s"' % self.gds_format_integer(self.returned, input_name='returned'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='field_goalType14', fromsubclass_=False, pretty_print=True):
        super(field_goalType14, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'returned' not in already_processed:
            already_processed.add('returned')
            self.returned = self.gds_parse_integer(value, node, 'returned')
        super(field_goalType14, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(field_goalType14, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class field_goalType14


class extra_pointType15(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, missed=None, made=None, blocked=None, returned=None, safety=None, aborted=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("extra_pointType15"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.missed = _cast(int, missed)
        self.missed_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, extra_pointType15)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if extra_pointType15.subclass:
            return extra_pointType15.subclass(*args_, **kwargs_)
        else:
            return extra_pointType15(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(extra_pointType15, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extra_pointType15', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('extra_pointType15')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'extra_pointType15':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='extra_pointType15')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='extra_pointType15', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='extra_pointType15'):
        super(extra_pointType15, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='extra_pointType15')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.missed is not None and 'missed' not in already_processed:
        ...
        if self.aborted is not None and 'aborted' not in already_processed:
            already_processed.add('aborted')
            outfile.write(' aborted="%s"' % self.gds_format_integer(self.aborted, input_name='aborted'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='extra_pointType15', fromsubclass_=False, pretty_print=True):
        super(extra_pointType15, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'aborted' not in already_processed:
            already_processed.add('aborted')
            self.aborted = self.gds_parse_integer(value, node, 'aborted')
        super(extra_pointType15, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(extra_pointType15, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class extra_pointType15


class penaltyType16(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, penalty=None, yards=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("penaltyType16"), self).__init__(nullified, team, player,  **kwargs_)
        self.penalty = _cast(int, penalty)
        self.penalty_nsprefix_ = None
        self.yards = _cast(int, yards)
        self.yards_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, penaltyType16)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if penaltyType16.subclass:
            return penaltyType16.subclass(*args_, **kwargs_)
        else:
            return penaltyType16(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(penaltyType16, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='penaltyType16', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('penaltyType16')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'penaltyType16':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='penaltyType16')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='penaltyType16', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='penaltyType16'):
        super(penaltyType16, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='penaltyType16')
        if self.penalty is not None and 'penalty' not in already_processed:
            already_processed.add('penalty')
            outfile.write(' penalty="%s"' % self.gds_format_integer(self.penalty, input_name='penalty'))
        if self.yards is not None and 'yards' not in already_processed:
            already_processed.add('yards')
            outfile.write(' yards="%s"' % self.gds_format_integer(self.yards, input_name='yards'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='penaltyType16', fromsubclass_=False, pretty_print=True):
        super(penaltyType16, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'yards' not in already_processed:
            already_processed.add('yards')
            self.yards = self.gds_parse_integer(value, node, 'yards')
        super(penaltyType16, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(penaltyType16, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class penaltyType16


class fumbleType17(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, fumble=None, forced=None, out_of_bounds=None, own_rec=None, opp_rec=None, own_rec_yards=None, opp_rec_yards=None, own_rec_td=None, opp_rec_td=None, lost=None, play_category=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("fumbleType17"), self).__init__(nullified, team, player,  **kwargs_)
        self.fumble = _cast(int, fumble)
        self.fumble_nsprefix_ = None
        self.forced = _cast(int, forced)
        self.forced_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, fumbleType17)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if fumbleType17.subclass:
            return fumbleType17.subclass(*args_, **kwargs_)
        else:
            return fumbleType17(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(fumbleType17, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fumbleType17', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('fumbleType17')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'fumbleType17':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fumbleType17')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='fumbleType17', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='fumbleType17'):
        super(fumbleType17, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='fumbleType17')
        if self.fumble is not None and 'fumble' not in already_processed:
            already_processed.add('fumble')
            outfile.write(' fumble="%s"' % self.gds_format_integer(self.fumble, input_name='fumble'))
        if self.forced is not None and 'forced' not in already_processed:
        ...
        if self.play_category is not None and 'play_category' not in already_processed:
            already_processed.add('play_category')
            outfile.write(' play_category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.play_category), input_name='play_category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='fumbleType17', fromsubclass_=False, pretty_print=True):
        super(fumbleType17, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'play_category' not in already_processed:
            already_processed.add('play_category')
            self.play_category = value
        super(fumbleType17, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(fumbleType17, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class fumbleType17


class returnType18(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, return_=None, yards=None, touchdown=None, firstdown=None, faircatch=None, out_of_bounds=None, downed=None, touchback=None, lateral=None, category=None, play_category=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("returnType18"), self).__init__(nullified, team, player,  **kwargs_)
        self.return_ = _cast(int, return_)
        self.return__nsprefix_ = None
        self.yards = _cast(int, yards)
        self.yards_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, returnType18)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if returnType18.subclass:
            return returnType18.subclass(*args_, **kwargs_)
        else:
            return returnType18(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_play_category(self, play_category):
        self.play_category = play_category
    def validate_categoryType19(self, value):
        # Validate type categoryType19, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on categoryType19' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            super(returnType18, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='returnType18', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('returnType18')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'returnType18':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='returnType18')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='returnType18', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='returnType18'):
        super(returnType18, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='returnType18')
        if self.return_ is not None and 'return_' not in already_processed:
            already_processed.add('return_')
            outfile.write(' return="%s"' % self.gds_format_integer(self.return_, input_name='return'))
        if self.yards is not None and 'yards' not in already_processed:
        ...
        if self.play_category is not None and 'play_category' not in already_processed:
            already_processed.add('play_category')
            outfile.write(' play_category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.play_category), input_name='play_category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='returnType18', fromsubclass_=False, pretty_print=True):
        super(returnType18, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'category' not in already_processed:
            already_processed.add('category')
            self.category = value
            self.validate_categoryType19(self.category)    # validate type categoryType19
        value = find_attr_value_('play_category', node)
        if value is not None and 'play_category' not in already_processed:
            already_processed.add('play_category')
            self.play_category = value
        super(returnType18, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(returnType18, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class returnType18


class blockType20(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, block=None, category=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("blockType20"), self).__init__(nullified, team, player,  **kwargs_)
        self.block = _cast(int, block)
        self.block_nsprefix_ = None
        self.category = _cast(None, category)
        self.category_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, blockType20)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if blockType20.subclass:
            return blockType20.subclass(*args_, **kwargs_)
        else:
            return blockType20(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def set_category(self, category):
        self.category = category
    def validate_categoryType21(self, value):
        # Validate type categoryType21, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on categoryType21' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            super(blockType20, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='blockType20', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('blockType20')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'blockType20':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='blockType20')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='blockType20', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='blockType20'):
        super(blockType20, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='blockType20')
        if self.block is not None and 'block' not in already_processed:
            already_processed.add('block')
            outfile.write(' block="%s"' % self.gds_format_integer(self.block, input_name='block'))
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='blockType20', fromsubclass_=False, pretty_print=True):
        super(blockType20, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'category' not in already_processed:
            already_processed.add('category')
            self.category = value
            self.validate_categoryType21(self.category)    # validate type categoryType21
        super(blockType20, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(blockType20, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class blockType20


class defenseType22(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, tackle=None, ast_tackle=None, primary=None, sack=None, ast_sack=None, sack_yards=None, block=None, pass_defended=None, qb_hit=None, interception=None, int_yards=None, int_touchdown=None, tlost=None, ast_tlost=None, tlost_yards=None, forced_fumble=None, safety=None, category=None, def_target=None, def_comp=None, blitz=None, hurry=None, knockdown=None, missed_tackles=None, batted_pass=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("defenseType22"), self).__init__(nullified, team, player,  **kwargs_)
        self.tackle = _cast(int, tackle)
        self.tackle_nsprefix_ = None
        self.ast_tackle = _cast(int, ast_tackle)
        self.ast_tackle_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, defenseType22)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if defenseType22.subclass:
            return defenseType22.subclass(*args_, **kwargs_)
        else:
            return defenseType22(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(defenseType22, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defenseType22', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('defenseType22')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'defenseType22':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='defenseType22')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='defenseType22', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='defenseType22'):
        super(defenseType22, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='defenseType22')
        if self.tackle is not None and 'tackle' not in already_processed:
            already_processed.add('tackle')
            outfile.write(' tackle="%s"' % self.gds_format_integer(self.tackle, input_name='tackle'))
        if self.ast_tackle is not None and 'ast_tackle' not in already_processed:
        ...
        if self.batted_pass is not None and 'batted_pass' not in already_processed:
            already_processed.add('batted_pass')
            outfile.write(' batted_pass="%s"' % self.gds_format_integer(self.batted_pass, input_name='batted_pass'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defenseType22', fromsubclass_=False, pretty_print=True):
        super(defenseType22, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'batted_pass' not in already_processed:
            already_processed.add('batted_pass')
            self.batted_pass = self.gds_parse_integer(value, node, 'batted_pass')
        super(defenseType22, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(defenseType22, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class defenseType22


class conversionType23(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, complete=None, safety=None, category=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("conversionType23"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.complete = _cast(int, complete)
        self.complete_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, conversionType23)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if conversionType23.subclass:
            return conversionType23.subclass(*args_, **kwargs_)
        else:
            return conversionType23(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(conversionType23, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='conversionType23', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('conversionType23')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'conversionType23':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='conversionType23')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='conversionType23', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='conversionType23'):
        super(conversionType23, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='conversionType23')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.complete is not None and 'complete' not in already_processed:
        ...
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='conversionType23', fromsubclass_=False, pretty_print=True):
        super(conversionType23, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(conversionType23, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(conversionType23, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class conversionType23


class defense_conversionType25(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, attempt=None, complete=None, category=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("defense_conversionType25"), self).__init__(nullified, team, player,  **kwargs_)
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
        self.complete = _cast(int, complete)
        self.complete_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, defense_conversionType25)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if defense_conversionType25.subclass:
            return defense_conversionType25.subclass(*args_, **kwargs_)
        else:
            return defense_conversionType25(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def validate_categoryType26(self, value):
        # Validate type categoryType26, a restriction on xs:string.
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s is not of the correct base simple type (str)' % {"value": value, "lineno": lineno, })
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s"%(lineno)s does not match xsd enumeration restriction on categoryType26' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
    def has__content(self):
        if (
            super(defense_conversionType25, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defense_conversionType25', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('defense_conversionType25')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'defense_conversionType25':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='defense_conversionType25')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='defense_conversionType25', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='defense_conversionType25'):
        super(defense_conversionType25, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='defense_conversionType25')
        if self.attempt is not None and 'attempt' not in already_processed:
            already_processed.add('attempt')
            outfile.write(' attempt="%s"' % self.gds_format_integer(self.attempt, input_name='attempt'))
        if self.complete is not None and 'complete' not in already_processed:
        ...
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='defense_conversionType25', fromsubclass_=False, pretty_print=True):
        super(defense_conversionType25, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(defense_conversionType25, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(defense_conversionType25, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class defense_conversionType25


class down_conversionType27(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, down=None, attempt=None, complete=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("down_conversionType27"), self).__init__(nullified, team, player,  **kwargs_)
        self.down = _cast(int, down)
        self.down_nsprefix_ = None
        self.attempt = _cast(int, attempt)
        self.attempt_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, down_conversionType27)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if down_conversionType27.subclass:
            return down_conversionType27.subclass(*args_, **kwargs_)
        else:
            return down_conversionType27(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(down_conversionType27, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='down_conversionType27', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('down_conversionType27')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'down_conversionType27':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='down_conversionType27')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='down_conversionType27', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='down_conversionType27'):
        super(down_conversionType27, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='down_conversionType27')
        if self.down is not None and 'down' not in already_processed:
            already_processed.add('down')
            outfile.write(' down="%s"' % self.gds_format_integer(self.down, input_name='down'))
        if self.attempt is not None and 'attempt' not in already_processed:
        ...
        if self.complete is not None and 'complete' not in already_processed:
            already_processed.add('complete')
            outfile.write(' complete="%s"' % self.gds_format_integer(self.complete, input_name='complete'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='down_conversionType27', fromsubclass_=False, pretty_print=True):
        super(down_conversionType27, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'complete' not in already_processed:
            already_processed.add('complete')
            self.complete = self.gds_parse_integer(value, node, 'complete')
        super(down_conversionType27, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(down_conversionType27, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class down_conversionType27


class first_downType28(basePlayStatisticType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = basePlayStatisticType
    def __init__(self, nullified=None, team=None, player=None, category=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("first_downType28"), self).__init__(nullified, team, player,  **kwargs_)
        self.category = _cast(None, category)
        self.category_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, first_downType28)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if first_downType28.subclass:
            return first_downType28.subclass(*args_, **kwargs_)
        else:
            return first_downType28(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            super(first_downType28, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='first_downType28', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('first_downType28')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'first_downType28':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='first_downType28')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='first_downType28', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='first_downType28'):
        super(first_downType28, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='first_downType28')
        if self.category is not None and 'category' not in already_processed:
            already_processed.add('category')
            outfile.write(' category=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.category), input_name='category')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='first_downType28', fromsubclass_=False, pretty_print=True):
        super(first_downType28, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        super(first_downType28, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        super(first_downType28, self)._buildChildren(child_, node, nodeName_, True)
        pass
# end class first_downType28


class drive_infoType30(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, duration=None, net_yards=None, play_count=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, drive_infoType30)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if drive_infoType30.subclass:
            return drive_infoType30.subclass(*args_, **kwargs_)
        else:
            return drive_infoType30(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='drive-infoType30', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('drive-infoType30')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'drive-infoType30':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='drive-infoType30')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='drive-infoType30', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='drive-infoType30'):
        if self.duration is not None and 'duration' not in already_processed:
            already_processed.add('duration')
            outfile.write(' duration=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.duration), input_name='duration')), ))
        if self.net_yards is not None and 'net_yards' not in already_processed:
        ...
        if self.play_count is not None and 'play_count' not in already_processed:
            already_processed.add('play_count')
            outfile.write(' play_count="%s"' % self.gds_format_integer(self.play_count, input_name='play_count'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='drive-infoType30', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class drive_infoType30


class penaltyType31(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, penaltyType31)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if penaltyType31.subclass:
            return penaltyType31.subclass(*args_, **kwargs_)
        else:
            return penaltyType31(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='penaltyType31', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('penaltyType31')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'penaltyType31':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='penaltyType31')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='penaltyType31', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='penaltyType31'):
        if self.description is not None and 'description' not in already_processed:
            already_processed.add('description')
            outfile.write(' description=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.description), input_name='description')), ))
        if self.result is not None and 'result' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='penaltyType31', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class recoveryType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='recoveryType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='recoveryType'):
        ...
        if self.first_touch is not None and 'first_touch' not in already_processed:
            already_processed.add('first_touch')
            outfile.write(' first_touch=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.first_touch), input_name='first_touch')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='recoveryType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class reviewType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='reviewType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='reviewType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class playersType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playersType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='playersType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playersType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'player':
            obj_ = playerType32.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.player.append(obj_)
            obj_.original_tagname_ = 'player'
...
class playerType32(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, playerType32)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if playerType32.subclass:
            return playerType32.subclass(*args_, **kwargs_)
        else:
            return playerType32(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playerType32', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('playerType32')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'playerType32':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='playerType32')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='playerType32', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='playerType32'):
        ...
        if self.position is not None and 'position' not in already_processed:
            already_processed.add('position')
            outfile.write(' position=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.position), input_name='position')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='playerType32', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class drive_infoType33(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='drive-infoType33', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='drive-infoType33'):
        ...
        if self.play_count is not None and 'play_count' not in already_processed:
            already_processed.add('play_count')
            outfile.write(' play_count="%s"' % self.gds_format_integer(self.play_count, input_name='play_count'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='drive-infoType33', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class quarterType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='quarterType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='quarterType'):
        ...
        if self.sequence is not None and 'sequence' not in already_processed:
            already_processed.add('sequence')
            outfile.write(' sequence="%s"' % self.gds_format_integer(self.sequence, input_name='sequence'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='quarterType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class overtimeType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='overtimeType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='overtimeType'):
        ...
        if self.sequence is not None and 'sequence' not in already_processed:
            already_processed.add('sequence')
            outfile.write(' sequence="%s"' % self.gds_format_integer(self.sequence, input_name='sequence'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='overtimeType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class detailsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='detailsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='detailsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='detailsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class homeType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='homeType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='homeType'):
        ...
        if self.direction is not None and 'direction' not in already_processed:
            already_processed.add('direction')
            outfile.write(' direction=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.direction), input_name='direction')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='homeType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class awayType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='awayType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='awayType'):
        ...
        if self.direction is not None and 'direction' not in already_processed:
            already_processed.add('direction')
            outfile.write(' direction=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.direction), input_name='direction')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='awayType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class windType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='windType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='windType'):
        ...
        if self.direction is not None and 'direction' not in already_processed:
            already_processed.add('direction')
            outfile.write(' direction=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.direction), input_name='direction')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='windType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class locationType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='locationType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='locationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class rgb_colorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='rgb_colorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='rgb_colorType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class gameTeamType(teamType):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameTeamType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"', name_='gameTeamType', fromsubclass_=False, pretty_print=True):
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:r="http://feed.elasticstats.com/schema/football/roster-v7.0.xsd"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from roster-v7.0 import *\n\n')
        sys.stdout.write('import roster-v7.0 as model_\n\n')
...
NamespaceToDefMappings_ = {'http://feed.elasticstats.com/schema/football/roster-v7.0.xsd': [('gameType',
                                                                   'roster-v7.0.xsd',
                                                                   'CT'),
                                                                  ('teamRosterType',
                                                                   'roster-v7.0.xsd',
...
__all__ = [
    ...
    "defense_conversionType25",
    "detailsType",
    "down_conversionType",
    "down_conversionType27",
    "draftType",
    "drive_infoType",
    "drive_infoType30",
    "drive_infoType33",
