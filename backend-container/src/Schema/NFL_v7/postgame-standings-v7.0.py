...
#
# Generated Sat Dec 16 08:30:11 2023 by generateDS.py version 2.43.3.
# Python 3.10.12 (main, Nov 20 2023, 15:14:05) [GCC 11.4.0]
#
# Command line options:
#   ('-o', 'postgame-standings-v7.0.py')
#
# Command line arguments:
#   postgame-standings-v7.0.xsd
#
# Command line:
#   /home/zepor/.local/bin/generateDS -o "postgame-standings-v7.0.py" postgame-standings-v7.0.xsd
#
...
class seasonType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, id=None, name=None, year=None, type_=None, conference=None, gds_collector_=None, **kwargs_):
    ...
    def set_conference(self, conference):
        self.conference = conference
    def add_conference(self, value):
        self.conference.append(value)
    def insert_conference_at(self, index, value):
        self.conference.insert(index, value)
    def replace_conference_at(self, index, value):
        self.conference[index] = value
    def get_id(self):
        return self.id
    def set_id(self, id):
        self.id = id
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='seasonType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            ...
            eol_ = ''
        for conference_ in self.conference:
            namespaceprefix_ = self.conference_nsprefix_ + ':' if (UseCapturedNS_ and self.conference_nsprefix_) else ''
            conference_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='conference', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'conference':
            obj_ = conferenceType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.conference.append(obj_)
            obj_.original_tagname_ = 'conference'
# end class seasonType


class conferenceType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, id=None, sr_id=None, alias=None, name=None, division=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.division_nsprefix_ = "s"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, conferenceType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if conferenceType.subclass:
            return conferenceType.subclass(*args_, **kwargs_)
        else:
            return conferenceType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='conferenceType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('conferenceType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'conferenceType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='conferenceType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='conferenceType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='conferenceType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.id), input_name='id')), ))
        ...
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='conferenceType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'division':
            obj_ = divisionType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.division.append(obj_)
            obj_.original_tagname_ = 'division'
# end class conferenceType


class divisionType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, id=None, sr_id=None, alias=None, name=None, team=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, divisionType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if divisionType.subclass:
            return divisionType.subclass(*args_, **kwargs_)
        else:
            return divisionType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='divisionType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('divisionType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'divisionType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='divisionType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='divisionType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='divisionType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.id), input_name='id')), ))
        if self.sr_id is not None and 'sr_id' not in already_processed:
        ...
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='divisionType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
# end class divisionType


class streakType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, desc=None, length=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, streakType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if streakType.subclass:
            return streakType.subclass(*args_, **kwargs_)
        else:
            return streakType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='streakType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('streakType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'streakType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='streakType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='streakType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='streakType'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='streakType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class recordType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, category=None, wins=None, losses=None, ties=None, win_pct=None, points_against=None, points_for=None, points_rank=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.win_pct = _cast(float, win_pct)
        self.win_pct_nsprefix_ = None
        self.points_against = _cast(int, points_against)
        self.points_against_nsprefix_ = None
        self.points_for = _cast(int, points_for)
        self.points_for_nsprefix_ = None
        self.points_rank = _cast(int, points_rank)
        self.points_rank_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def set_points_against(self, points_against):
        self.points_against = points_against
    def get_points_for(self):
        return self.points_for
    def set_points_for(self, points_for):
        self.points_for = points_for
    def get_points_rank(self):
        return self.points_rank
    def set_points_rank(self, points_rank):
    ...
    def validate_categoryType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, str):
                ...
                return False
            value = value
            enumerations = ['conference', 'division', 'home', 'road', 'away', 'nfc', 'afc']
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='recordType'):
        ...
        if self.win_pct is not None and 'win_pct' not in already_processed:
            already_processed.add('win_pct')
            outfile.write(' win_pct="%s"' % self.gds_format_decimal(self.win_pct, input_name='win_pct'))
        if self.points_against is not None and 'points_against' not in already_processed:
            already_processed.add('points_against')
            outfile.write(' points_against="%s"' % self.gds_format_integer(self.points_against, input_name='points_against'))
        if self.points_for is not None and 'points_for' not in already_processed:
            already_processed.add('points_for')
            outfile.write(' points_for="%s"' % self.gds_format_integer(self.points_for, input_name='points_for'))
        if self.points_rank is not None and 'points_rank' not in already_processed:
            already_processed.add('points_rank')
            outfile.write(' points_rank="%s"' % self.gds_format_integer(self.points_rank, input_name='points_rank'))
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        value = find_attr_value_('win_pct', node)
        if value is not None and 'win_pct' not in already_processed:
            already_processed.add('win_pct')
            value = self.gds_parse_decimal(value, node, 'win_pct')
            self.win_pct = value
        value = find_attr_value_('points_against', node)
        if value is not None and 'points_against' not in already_processed:
            already_processed.add('points_against')
            self.points_against = self.gds_parse_integer(value, node, 'points_against')
        value = find_attr_value_('points_for', node)
        if value is not None and 'points_for' not in already_processed:
            already_processed.add('points_for')
            self.points_for = self.gds_parse_integer(value, node, 'points_for')
        value = find_attr_value_('points_rank', node)
        if value is not None and 'points_rank' not in already_processed:
            already_processed.add('points_rank')
            self.points_rank = self.gds_parse_integer(value, node, 'points_rank')
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
...
class teamType1(teamType):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = teamType
    def __init__(self, id=None, sr_id=None, alias=None, name=None, market=None, founded=None, reference=None, wins=None, losses=None, ties=None, win_pct=None, points_against=None, points_for=None, points_rank=None, rank=None, streak=None, strength_of_schedule=None, strength_of_victory=None, records=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        super(globals().get("teamType1"), self).__init__(id, sr_id, alias, name, market, founded, reference,  **kwargs_)
        self.wins = _cast(int, wins)
        self.wins_nsprefix_ = None
        self.losses = _cast(int, losses)
        self.losses_nsprefix_ = None
        ...
        self.streak = streak
        self.streak_nsprefix_ = None
        self.strength_of_schedule = strength_of_schedule
        self.strength_of_schedule_nsprefix_ = None
        self.strength_of_victory = strength_of_victory
        self.strength_of_victory_nsprefix_ = None
        self.records = records
        self.records_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
    ...
    def get_strength_of_schedule(self):
        return self.strength_of_schedule
    def set_strength_of_schedule(self, strength_of_schedule):
        self.strength_of_schedule = strength_of_schedule
    def get_strength_of_victory(self):
        return self.strength_of_victory
    def set_strength_of_victory(self, strength_of_victory):
        self.strength_of_victory = strength_of_victory
    ...
    def has__content(self):
        if (
            ...
            self.streak is not None or
            self.strength_of_schedule is not None or
            self.strength_of_victory is not None or
            self.records is not None or
            super(teamType1, self).has__content()
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='teamType1', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamType1'):
        super(teamType1, self)._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='teamType1')
        if self.wins is not None and 'wins' not in already_processed:
            already_processed.add('wins')
            outfile.write(' wins="%s"' % self.gds_format_integer(self.wins, input_name='wins'))
        if self.losses is not None and 'losses' not in already_processed:
        ...
        if self.points_rank is not None and 'points_rank' not in already_processed:
            already_processed.add('points_rank')
            outfile.write(' points_rank="%s"' % self.gds_format_integer(self.points_rank, input_name='points_rank'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='teamType1', fromsubclass_=False, pretty_print=True):
        super(teamType1, self)._exportChildren(outfile, level, namespaceprefix_, namespacedef_, name_, True, pretty_print=pretty_print)
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.streak is not None:
            namespaceprefix_ = self.streak_nsprefix_ + ':' if (UseCapturedNS_ and self.streak_nsprefix_) else ''
            self.streak.export(outfile, level, namespaceprefix_, namespacedef_='', name_='streak', pretty_print=pretty_print)
        if self.strength_of_schedule is not None:
            namespaceprefix_ = self.strength_of_schedule_nsprefix_ + ':' if (UseCapturedNS_ and self.strength_of_schedule_nsprefix_) else ''
            self.strength_of_schedule.export(outfile, level, namespaceprefix_, namespacedef_='', name_='strength-of-schedule', pretty_print=pretty_print)
        if self.strength_of_victory is not None:
            namespaceprefix_ = self.strength_of_victory_nsprefix_ + ':' if (UseCapturedNS_ and self.strength_of_victory_nsprefix_) else ''
            self.strength_of_victory.export(outfile, level, namespaceprefix_, namespacedef_='', name_='strength-of-victory', pretty_print=pretty_print)
        if self.records is not None:
            namespaceprefix_ = self.records_nsprefix_ + ':' if (UseCapturedNS_ and self.records_nsprefix_) else ''
            self.records.export(outfile, level, namespaceprefix_, namespacedef_='', name_='records', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'points_rank' not in already_processed:
            already_processed.add('points_rank')
            self.points_rank = self.gds_parse_integer(value, node, 'points_rank')
        super(teamType1, self)._buildAttributes(node, attrs, already_processed)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'rank':
            obj_ = rankType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.rank = obj_
            obj_.original_tagname_ = 'rank'
        elif nodeName_ == 'streak':
            obj_ = streakType2.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.streak = obj_
            obj_.original_tagname_ = 'streak'
        elif nodeName_ == 'strength-of-schedule':
            obj_ = strength_of_scheduleType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.strength_of_schedule = obj_
            obj_.original_tagname_ = 'strength-of-schedule'
        elif nodeName_ == 'strength-of-victory':
            obj_ = strength_of_victoryType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.strength_of_victory = obj_
            obj_.original_tagname_ = 'strength-of-victory'
        elif nodeName_ == 'records':
            obj_ = recordsType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.records = obj_
            obj_.original_tagname_ = 'records'
        super(teamType1, self)._buildChildren(child_, node, nodeName_, True)
# end class teamType1


class rankType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, division=None, conference=None, gds_collector_=None, **kwargs_):
        ...
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = None
        self.division = _cast(int, division)
        self.division_nsprefix_ = None
        self.conference = _cast(int, conference)
        self.conference_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, rankType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if rankType.subclass:
            return rankType.subclass(*args_, **kwargs_)
        else:
            return rankType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rankType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('rankType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'rankType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='rankType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='rankType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='rankType'):
        if self.division is not None and 'division' not in already_processed:
            already_processed.add('division')
            outfile.write(' division="%s"' % self.gds_format_integer(self.division, input_name='division'))
        if self.conference is not None and 'conference' not in already_processed:
            already_processed.add('conference')
            outfile.write(' conference="%s"' % self.gds_format_integer(self.conference, input_name='conference'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='rankType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'division' not in already_processed:
            already_processed.add('division')
            self.division = self.gds_parse_integer(value, node, 'division')
        value = find_attr_value_('conference', node)
        if value is not None and 'conference' not in already_processed:
            already_processed.add('conference')
            self.conference = self.gds_parse_integer(value, node, 'conference')
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class rankType


class streakType2(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, type_=None, length=None, desc=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, streakType2)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if streakType2.subclass:
            return streakType2.subclass(*args_, **kwargs_)
        else:
            return streakType2(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='streakType2', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('streakType2')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'streakType2':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='streakType2')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='streakType2', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='streakType2'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.type_), input_name='type')), ))
        if self.length is not None and 'length' not in already_processed:
        ...
        if self.desc is not None and 'desc' not in already_processed:
            already_processed.add('desc')
            outfile.write(' desc=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.desc), input_name='desc')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='streakType2', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class streakType2


class strength_of_scheduleType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, wins=None, total=None, sos=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.sos = _cast(float, sos)
        self.sos_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, strength_of_scheduleType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if strength_of_scheduleType.subclass:
            return strength_of_scheduleType.subclass(*args_, **kwargs_)
        else:
            return strength_of_scheduleType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='strength-of-scheduleType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('strength-of-scheduleType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'strength-of-scheduleType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='strength-of-scheduleType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='strength-of-scheduleType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='strength-of-scheduleType'):
        if self.wins is not None and 'wins' not in already_processed:
            already_processed.add('wins')
            outfile.write(' wins="%s"' % self.gds_format_integer(self.wins, input_name='wins'))
        ...
        if self.sos is not None and 'sos' not in already_processed:
            already_processed.add('sos')
            outfile.write(' sos="%s"' % self.gds_format_decimal(self.sos, input_name='sos'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='strength-of-scheduleType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'total' not in already_processed:
            already_processed.add('total')
            self.total = self.gds_parse_integer(value, node, 'total')
        value = find_attr_value_('sos', node)
        if value is not None and 'sos' not in already_processed:
            already_processed.add('sos')
            value = self.gds_parse_decimal(value, node, 'sos')
            self.sos = value
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class strength_of_scheduleType


class strength_of_victoryType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, wins=None, total=None, sov=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.total = _cast(int, total)
        self.total_nsprefix_ = None
        self.sov = _cast(float, sov)
        self.sov_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, strength_of_victoryType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if strength_of_victoryType.subclass:
            return strength_of_victoryType.subclass(*args_, **kwargs_)
        else:
            return strength_of_victoryType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='strength-of-victoryType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('strength-of-victoryType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'strength-of-victoryType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='strength-of-victoryType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='strength-of-victoryType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='strength-of-victoryType'):
        if self.wins is not None and 'wins' not in already_processed:
            already_processed.add('wins')
            outfile.write(' wins="%s"' % self.gds_format_integer(self.wins, input_name='wins'))
        if self.total is not None and 'total' not in already_processed:
            already_processed.add('total')
            outfile.write(' total="%s"' % self.gds_format_integer(self.total, input_name='total'))
        if self.sov is not None and 'sov' not in already_processed:
            already_processed.add('sov')
            outfile.write(' sov="%s"' % self.gds_format_decimal(self.sov, input_name='sov'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='strength-of-victoryType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'total' not in already_processed:
            already_processed.add('total')
            self.total = self.gds_parse_integer(value, node, 'total')
        value = find_attr_value_('sov', node)
        if value is not None and 'sov' not in already_processed:
            already_processed.add('sov')
            value = self.gds_parse_decimal(value, node, 'sov')
            self.sov = value
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class strength_of_victoryType


class recordsType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, record=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, recordsType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if recordsType.subclass:
            return recordsType.subclass(*args_, **kwargs_)
        else:
            return recordsType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='recordsType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('recordsType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'recordsType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='recordsType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='recordsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='recordsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='', name_='recordsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from postgame-standings-v7.0 import *\n\n')
        sys.stdout.write('import postgame-standings-v7.0 as model_\n\n')
...
NamespaceToDefMappings_ = {'http://feed.elasticstats.com/schema/football/nfl/postgame-standings-v7.0.xsd': [('seasonType',
                                                                                   'postgame-standings-v7.0.xsd',
                                                                                   'CT'),
                                                                                  ('conferenceType',
                                                                                   'postgame-standings-v7.0.xsd',
...
__all__ = [
    ...
    "streakType",
    "streakType2",
    "strength_of_scheduleType",
    "strength_of_victoryType",
    "teamColorType",
    "teamColorsType",
    "teamType",
    "teamType1",
