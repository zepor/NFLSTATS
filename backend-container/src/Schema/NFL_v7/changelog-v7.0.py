...
#
# Generated Sat Dec 16 08:30:03 2023 by generateDS.py version 2.43.3.
...
#
# Command line:
#   /home/zepor/.local/bin/generateDS -o "changelog-v7.0.py" changelog-v7.0.xsd
#
...
#
class changelogType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, id=None, sr_id=None, alias=None, name=None, changelog=None, gds_collector_=None, **kwargs_):
        ...
        self.changelog_nsprefix_ = "c"
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, changelogType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if changelogType.subclass:
            return changelogType.subclass(*args_, **kwargs_)
        else:
            return changelogType(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            self.changelog is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='changelogType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('changelogType')
        ...
        if pretty_print:
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'changelogType':
        ...
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='changelogType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='changelogType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='changelogType'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='changelogType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.changelog is not None:
            namespaceprefix_ = self.changelog_nsprefix_ + ':' if (UseCapturedNS_ and self.changelog_nsprefix_) else ''
            self.changelog.export(outfile, level, namespaceprefix_, namespacedef_='', name_='changelog', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'changelog':
            obj_ = changelogType1.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.changelog = obj_
            obj_.original_tagname_ = 'changelog'
# end class changelogType


class teamEntryType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, last_modified=None, id=None, sr_id=None, alias=None, name=None, market=None, founded=None, reference=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.ns_prefix_ = "c"
        if isinstance(last_modified, BaseStrType_):
            initvalue_ = datetime_.datetime.strptime(last_modified, '%Y-%m-%dT%H:%M:%S')
        else:
            initvalue_ = last_modified
        self.last_modified = initvalue_
        self.id = _cast(None, id)
        self.id_nsprefix_ = None
        self.sr_id = _cast(None, sr_id)
        self.sr_id_nsprefix_ = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, teamEntryType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if teamEntryType.subclass:
            return teamEntryType.subclass(*args_, **kwargs_)
        else:
            return teamEntryType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamEntryType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('teamEntryType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'teamEntryType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='teamEntryType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='teamEntryType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamEntryType'):
        if self.last_modified is not None and 'last_modified' not in already_processed:
            already_processed.add('last_modified')
            outfile.write(' last_modified="%s"' % self.gds_format_datetime(self.last_modified, input_name='last_modified'))
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.id), input_name='id')), ))
        if self.sr_id is not None and 'sr_id' not in already_processed:
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamEntryType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
        ...
        return self
    def _buildAttributes(self, node, attrs, already_processed):
        value = find_attr_value_('last_modified', node)
        if value is not None and 'last_modified' not in already_processed:
            already_processed.add('last_modified')
            try:
                self.last_modified = self.gds_parse_datetime(value)
            except ValueError as exp:
                raise ValueError('Bad date-time attribute (last_modified): %s' % exp)
        value = find_attr_value_('id', node)
        if value is not None and 'id' not in already_processed:
            already_processed.add('id')
            self.id = value
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class teamEntryType


class playerEntryType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, full_name=None, last_modified=None, id=None, sr_id=None, name=None, jersey=None, reference=None, position=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, playerEntryType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if playerEntryType.subclass:
            return playerEntryType.subclass(*args_, **kwargs_)
        else:
            return playerEntryType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='playerEntryType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('playerEntryType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'playerEntryType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='playerEntryType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='playerEntryType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='playerEntryType'):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='playerEntryType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class playerEntryType


class gameEntryType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, id=None, last_modified=None, season_id=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        if isinstance(last_modified, BaseStrType_):
            ...
            initvalue_ = last_modified
        self.last_modified = initvalue_
        self.season_id = _cast(None, season_id)
        self.season_id_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, gameEntryType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if gameEntryType.subclass:
            return gameEntryType.subclass(*args_, **kwargs_)
        else:
            return gameEntryType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='gameEntryType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('gameEntryType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'gameEntryType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='gameEntryType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='gameEntryType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='gameEntryType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.id), input_name='id')), ))
        if self.last_modified is not None and 'last_modified' not in already_processed:
            already_processed.add('last_modified')
            outfile.write(' last_modified="%s"' % self.gds_format_datetime(self.last_modified, input_name='last_modified'))
        if self.season_id is not None and 'season_id' not in already_processed:
            already_processed.add('season_id')
            outfile.write(' season_id=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.season_id), input_name='season_id')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='gameEntryType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'last_modified' not in already_processed:
            ...
            try:
                ...
                raise ValueError('Bad date-time attribute (last_modified): %s' % exp)
        value = find_attr_value_('season_id', node)
        if value is not None and 'season_id' not in already_processed:
            already_processed.add('season_id')
            self.season_id = value
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        pass
# end class gameEntryType
...
class referenceType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='referenceType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='referenceType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class venueType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='venueType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='venueType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamType'):
        ...
        if self.reference is not None and 'reference' not in already_processed:
            already_processed.add('reference')
            outfile.write(' reference=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.reference), input_name='reference')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class references(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='references', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='references'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='references', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class franchise(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='franchise', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='franchise'):
        ...
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='franchise', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamColorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamColorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamColorsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamColorsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamColorsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class changelogType1(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, end_time=None, start_time=None, profiles=None, games=None, standings=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        ...
        self.games = games
        self.games_nsprefix_ = None
        self.standings = standings
        self.standings_nsprefix_ = None
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, changelogType1)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if changelogType1.subclass:
            return changelogType1.subclass(*args_, **kwargs_)
        else:
            return changelogType1(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            self.games is not None or
            self.standings is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='changelogType1', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('changelogType1')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'changelogType1':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='changelogType1')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='changelogType1', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='changelogType1'):
        if self.end_time is not None and 'end_time' not in already_processed:
            already_processed.add('end_time')
            outfile.write(' end_time="%s"' % self.gds_format_datetime(self.end_time, input_name='end_time'))
        if self.start_time is not None and 'start_time' not in already_processed:
            already_processed.add('start_time')
            outfile.write(' start_time="%s"' % self.gds_format_datetime(self.start_time, input_name='start_time'))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='changelogType1', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.games is not None:
            namespaceprefix_ = self.games_nsprefix_ + ':' if (UseCapturedNS_ and self.games_nsprefix_) else ''
            self.games.export(outfile, level, namespaceprefix_, namespacedef_='', name_='games', pretty_print=pretty_print)
        if self.standings is not None:
            namespaceprefix_ = self.standings_nsprefix_ + ':' if (UseCapturedNS_ and self.standings_nsprefix_) else ''
            self.standings.export(outfile, level, namespaceprefix_, namespacedef_='', name_='standings', pretty_print=pretty_print)
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
            self.gds_elementtree_node_ = node
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'end_time' not in already_processed:
            ...
            try:
                ...
                raise ValueError('Bad date-time attribute (end_time): %s' % exp)
        ...
        if value is not None and 'start_time' not in already_processed:
            ...
            try:
                ...
                raise ValueError('Bad date-time attribute (start_time): %s' % exp)
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'profiles':
            obj_ = profilesType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.profiles = obj_
            obj_.original_tagname_ = 'profiles'
        elif nodeName_ == 'games':
            obj_ = gamesType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.games = obj_
            obj_.original_tagname_ = 'games'
        elif nodeName_ == 'standings':
            obj_ = standingsType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.standings = obj_
            obj_.original_tagname_ = 'standings'
# end class changelogType1
...
class profilesType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, teams=None, players=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, profilesType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
    ...
    def has__content(self):
        if (
            self.teams is not None or
            self.players is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='profilesType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('profilesType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'profilesType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='profilesType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='profilesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='profilesType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='profilesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.teams is not None:
            ...
            self.teams.export(outfile, level, namespaceprefix_, namespacedef_='', name_='teams', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'teams':
            obj_ = teamsType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.teams = obj_
            obj_.original_tagname_ = 'teams'
...
class teamsType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, teamsType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if teamsType.subclass:
            return teamsType.subclass(*args_, **kwargs_)
        else:
            return teamsType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamsType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('teamsType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'teamsType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='teamsType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='teamsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='teamsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'team':
            obj_ = teamEntryType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class playersType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='playersType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='playersType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='playersType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'player':
            obj_ = playerEntryType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class gamesType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, schedule=None, results=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, gamesType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if gamesType.subclass:
            return gamesType.subclass(*args_, **kwargs_)
        else:
            return gamesType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='gamesType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('gamesType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'gamesType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='gamesType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='gamesType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='gamesType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='gamesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'schedule':
            obj_ = scheduleType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.schedule = obj_
...
class scheduleType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, game=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='scheduleType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('scheduleType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'scheduleType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='scheduleType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='scheduleType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='scheduleType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='scheduleType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'game':
            obj_ = gameEntryType.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
...
class resultsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='resultsType', pretty_print=True):
        ...
        if self.has__content():
            ...
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='resultsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='resultsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class standingsType(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    def __init__(self, team=None, gds_collector_=None, **kwargs_):
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, standingsType)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if standingsType.subclass:
            return standingsType.subclass(*args_, **kwargs_)
        else:
            return standingsType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='standingsType', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('standingsType')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'standingsType':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='standingsType')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='standingsType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='standingsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='standingsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class locationType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='locationType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='locationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class rgb_colorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='rgb_colorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"', name_='rgb_colorType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
def parse(inFileName, silence=False, print_warnings=True):
    ...
    if rootClass is None:
        rootTag = 'changelogType'
        rootClass = changelogType
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:c="http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from changelog-v7.0 import *\n\n')
        sys.stdout.write('import changelog-v7.0 as model_\n\n')
...
NamespaceToDefMappings_ = {'http://feed.elasticstats.com/schema/football/changelog-v7.0.xsd': [('changelogType',
                                                                      'changelog-v7.0.xsd',
                                                                      'CT'),
                                                                     ('teamEntryType',
                                                                      'changelog-v7.0.xsd',
