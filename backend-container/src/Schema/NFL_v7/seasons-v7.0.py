...
#
# Generated Sat Dec 16 08:30:14 2023 by generateDS.py version 2.43.3.
...
#
# Command line:
#   /home/zepor/.local/bin/generateDS -o "seasons-v7.0.py" seasons-v7.0.xsd
#
...
class leagueType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, id=None, sr_id=None, alias=None, name=None, season=None, gds_collector_=None, **kwargs_):
    ...
    def set_season(self, season):
        self.season = season
    def add_season(self, value):
        self.season.append(value)
    def insert_season_at(self, index, value):
        self.season.insert(index, value)
    def replace_season_at(self, index, value):
        self.season[index] = value
    def get_id(self):
        return self.id
    def set_id(self, id):
        self.id = id
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='leagueType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='leagueType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for season_ in self.season:
            namespaceprefix_ = self.season_nsprefix_ + ':' if (UseCapturedNS_ and self.season_nsprefix_) else ''
            season_.export(outfile, level, namespaceprefix_, namespacedef_='', name_='season', pretty_print=pretty_print)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'season':
            ...
            self.season.append(obj_)
            obj_.original_tagname_ = 'season'
# end class leagueType


class seasonTypeElement(GeneratedsSuper):
    __hash__ = GeneratedsSuper.__hash__
    subclass = None
    superclass = None
    ...
    def factory(*args_, **kwargs_):
        if CurrentSubclassModule_ is not None:
            subclass = getSubclassFromModule_(
                CurrentSubclassModule_, seasonTypeElement)
            if subclass is not None:
                return subclass(*args_, **kwargs_)
        if seasonTypeElement.subclass:
            return seasonTypeElement.subclass(*args_, **kwargs_)
        else:
            return seasonTypeElement(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_ns_prefix_(self):
        return self.ns_prefix_
    def set_ns_prefix_(self, ns_prefix):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='seasonTypeElement', pretty_print=True):
        imported_ns_def_ = GenerateDSNamespaceDefs_.get('seasonTypeElement')
        if imported_ns_def_ is not None:
            namespacedef_ = imported_ns_def_
        if pretty_print:
            eol_ = '\n'
            ...
            eol_ = ''
        if self.original_tagname_ is not None and name_ == 'seasonTypeElement':
            name_ = self.original_tagname_
        if UseCapturedNS_ and self.ns_prefix_:
            namespaceprefix_ = self.ns_prefix_ + ':'
        showIndent(outfile, level, pretty_print)
        outfile.write('<%s%s%s' % (namespaceprefix_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self._exportAttributes(outfile, level, already_processed, namespaceprefix_, name_='seasonTypeElement')
        if self.has__content():
            outfile.write('>%s' % (eol_, ))
            self._exportChildren(outfile, level + 1, namespaceprefix_, namespacedef_, name_='seasonTypeElement', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespaceprefix_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='seasonTypeElement'):
        ...
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='seasonTypeElement', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class seasonType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, id=None, year=None, start_date=None, end_date=None, status=None, type_=None, gds_collector_=None, **kwargs_):
        self.gds_collector_ = gds_collector_
        self.gds_elementtree_node_ = None
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='seasonType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='seasonType'):
        ...
        if self.start_date is not None and 'start_date' not in already_processed:
            already_processed.add('start_date')
            outfile.write(' start_date="%s"' % self.gds_format_date(self.start_date, input_name='start_date'))
        if self.end_date is not None and 'end_date' not in already_processed:
            already_processed.add('end_date')
            outfile.write(' end_date="%s"' % self.gds_format_date(self.end_date, input_name='end_date'))
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='seasonType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def _buildAttributes(self, node, attrs, already_processed):
        ...
        value = find_attr_value_('start_date', node)
        if value is not None and 'start_date' not in already_processed:
            already_processed.add('start_date')
            try:
                self.start_date = self.gds_parse_date(value)
            except ValueError as exp:
                raise ValueError('Bad date attribute (start_date): %s' % exp)
        value = find_attr_value_('end_date', node)
        if value is not None and 'end_date' not in already_processed:
            already_processed.add('end_date')
            try:
                self.end_date = self.gds_parse_date(value)
            except ValueError as exp:
                raise ValueError('Bad date attribute (end_date): %s' % exp)
    ...
    def _buildChildren(self, child_, node, nodeName_, fromsubclass_=False, gds_collector_=None):
        if nodeName_ == 'type':
            obj_ = seasonTypeElement.factory(parent_object_=self)
            obj_.build(child_, gds_collector_=gds_collector_)
            self.type_ = obj_
...
class referenceType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='referenceType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='referenceType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class venueType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='venueType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='venueType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='teamType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='teamType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class references(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='references', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='references'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='references', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class franchise(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='franchise', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='franchise'):
        ...
        if self.name is not None and 'name' not in already_processed:
            already_processed.add('name')
            outfile.write(' name=%s' % (self.gds_encode(self.gds_format_string(quote_attrib(self.name), input_name='name')), ))
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='franchise', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='teamColorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='teamColorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class teamColorsType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='teamColorsType', pretty_print=True):
    ...
    def _exportAttributes(self, outfile, level, already_processed, namespaceprefix_='', name_='teamColorsType'):
        pass
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='teamColorsType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class locationType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='locationType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='locationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
class rgb_colorType(GeneratedsSuper):
    ...
    def has__content(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='rgb_colorType', pretty_print=True):
    ...
    def _exportChildren(self, outfile, level, namespaceprefix_='', namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"', name_='rgb_colorType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node, gds_collector_=None):
        self.gds_collector_ = gds_collector_
        if SaveElementTreeNode:
...
def parseString(inString, silence=False, print_warnings=True):
    ...
    if not silence:
        ...
        rootObj.export(
            sys.stdout, 0, name_=rootTag,
            namespacedef_='xmlns:h="http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd"')
    if print_warnings and len(gds_collector.get_messages()) > 0:
        separator = ('-' * 50) + '\n'
        sys.stderr.write(separator)
        sys.stderr.write('----- Warnings -- count: {} -----\n'.format(
...
def parseLiteral(inFileName, silence=False, print_warnings=True):
    ...
    if not SaveElementTreeNode:
        ...
        rootNode = None
    if not silence:
        sys.stdout.write('#from seasons-v7.0 import *\n\n')
        sys.stdout.write('import seasons-v7.0 as model_\n\n')
...
NamespaceToDefMappings_ = {'http://feed.elasticstats.com/schema/football/seasons-v7.0.xsd': [('leagueType',
                                                                    'seasons-v7.0.xsd',
                                                                    'CT'),
                                                                   ('seasonTypeElement',
                                                                    'seasons-v7.0.xsd',
